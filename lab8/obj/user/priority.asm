...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 a0 1a 80 00 	movl   $0x801aa0,(%esp)
  ...
  800053:	e8 36 07 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 ba 1a 80 00 	movl   $0x801aba,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 bc 1a 80 00 	movl   $0x801abc,(%esp)
  ...
  8000a3:	e8 e6 06 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 ba 1a 80 00 	movl   $0x801aba,(%esp)
...
exit(int error_code) {
  ...
  800479:	c7 04 24 d8 1a 80 00 	movl   $0x801ad8,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800700:	c7 04 24 eb 1a 80 00 	movl   $0x801aeb,(%esp)
  ...
  80071e:	c7 04 24 f6 1a 80 00 	movl   $0x801af6,(%esp)
  ...
  800734:	c7 04 24 08 1b 80 00 	movl   $0x801b08,(%esp)
  ...
  80074a:	c7 04 24 1b 1b 80 00 	movl   $0x801b1b,(%esp)
  ...
  800760:	c7 04 24 2e 1b 80 00 	movl   $0x801b2e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a1d:	00 
  800a1e:	c7 44 24 04 41 1b 80 	movl   $0x801b41,0x4(%esp)
  800a25:	00 
  ...
  800a42:	c7 44 24 08 48 1b 80 	movl   $0x801b48,0x8(%esp)
  800a49:	00 
  800a4a:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a51:	00 
  800a52:	c7 04 24 62 1b 80 00 	movl   $0x801b62,(%esp)
  800a59:	e8 12 f6 ff ff       	call   800070 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a5e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a65:	00 
  800a66:	c7 44 24 04 74 1b 80 	movl   $0x801b74,0x4(%esp)
  800a6d:	00 
  ...
  800a8a:	c7 44 24 08 7c 1b 80 	movl   $0x801b7c,0x8(%esp)
  800a91:	00 
  800a92:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800a99:	00 
  800a9a:	c7 04 24 62 1b 80 00 	movl   $0x801b62,(%esp)
  ...
  800ab3:	e8 1d 0d 00 00       	call   8017d5 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  80109c:	05 a4 1d 80 00       	add    $0x801da4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  801200:	8b 04 85 c8 1d 80 00 	mov    0x801dc8(,%eax,4),%eax
  ...
  801319:	c7 44 24 0c be 1d 80 	movl   $0x801dbe,0xc(%esp)
  801320:	00 
  ...
  80134c:	75 05                	jne    801353 <vprintfmt+0x1c9>
                p = "(null)";
  80134e:	be c1 1d 80 00       	mov    $0x801dc1,%esi
            }
            if (width > 0 && padc != '-') {
...
spin_delay(void)
{
  ...
  8017b6:	eb 12                	jmp    8017ca <spin_delay+0x21>
     {
          j = !j;
  8017b8:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8017bb:	85 c0                	test   %eax,%eax
  8017bd:	0f 94 c0             	sete   %al
  8017c0:	0f b6 c0             	movzbl %al,%eax
  8017c3:	89 45 f8             	mov    %eax,-0x8(%ebp)
     for (i = 0; i != 200; ++ i)
  8017c6:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
  8017ca:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  8017d1:	75 e5                	jne    8017b8 <spin_delay+0xf>
     }
}
  8017d3:	c9                   	leave  
  8017d4:	c3                   	ret    
...
main(void) {
  ...
  8017d8:	56                   	push   %esi
  8017d9:	53                   	push   %ebx
  8017da:	83 e4 f0             	and    $0xfffffff0,%esp
  8017dd:	83 ec 20             	sub    $0x20,%esp
     int i,time;
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
  8017e0:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  8017e7:	00 
  8017e8:	c7 04 24 20 1f 80 00 	movl   $0x801f20,(%esp)
  8017ef:	e8 d5 ef ff ff       	call   8007c9 <cprintf>
     sleep(SLEEP_TIME);
  8017f4:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  8017fb:	e8 17 ed ff ff       	call   800517 <sleep>
     memset(pids, 0, sizeof(pids));
  801800:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
  801807:	00 
  801808:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80180f:	00 
  801810:	c7 04 24 70 31 80 00 	movl   $0x803170,(%esp)
  801817:	e8 00 f6 ff ff       	call   800e1c <memset>
     lab6_set_priority(TOTAL + 1);
  80181c:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  801823:	e8 dc ec ff ff       	call   800504 <lab6_set_priority>

     for (i = 0; i < TOTAL; i ++) {
  801828:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80182f:	00 
  801830:	e9 0e 01 00 00       	jmp    801943 <main+0x16e>
          acc[i]=0;
  801835:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801839:	c7 04 85 48 31 80 00 	movl   $0x0,0x803148(,%eax,4)
  801840:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  801844:	e8 3e ec ff ff       	call   800487 <fork>
  801849:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  80184d:	89 04 95 70 31 80 00 	mov    %eax,0x803170(,%edx,4)
  801854:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801858:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  80185f:	85 c0                	test   %eax,%eax
  801861:	0f 85 ba 00 00 00    	jne    801921 <main+0x14c>
               lab6_set_priority(i + 1);
  801867:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80186b:	83 c0 01             	add    $0x1,%eax
  80186e:	89 04 24             	mov    %eax,(%esp)
  801871:	e8 8e ec ff ff       	call   800504 <lab6_set_priority>
               acc[i] = 0;
  801876:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80187a:	c7 04 85 48 31 80 00 	movl   $0x0,0x803148(,%eax,4)
  801881:	00 00 00 00 
               while (1) {
                    spin_delay();
  801885:	e8 1f ff ff ff       	call   8017a9 <spin_delay>
                    ++ acc[i];
  80188a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80188e:	8b 04 85 48 31 80 00 	mov    0x803148(,%eax,4),%eax
  801895:	8d 50 01             	lea    0x1(%eax),%edx
  801898:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80189c:	89 14 85 48 31 80 00 	mov    %edx,0x803148(,%eax,4)
                    if(acc[i]%4000==0) {
  8018a3:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018a7:	8b 0c 85 48 31 80 00 	mov    0x803148(,%eax,4),%ecx
  8018ae:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  8018b3:	89 c8                	mov    %ecx,%eax
  8018b5:	f7 e2                	mul    %edx
  8018b7:	89 d0                	mov    %edx,%eax
  8018b9:	c1 e8 08             	shr    $0x8,%eax
  8018bc:	69 c0 a0 0f 00 00    	imul   $0xfa0,%eax,%eax
  8018c2:	29 c1                	sub    %eax,%ecx
  8018c4:	89 c8                	mov    %ecx,%eax
  8018c6:	85 c0                	test   %eax,%eax
  8018c8:	75 52                	jne    80191c <main+0x147>
                        if((time=gettime_msec())>SLEEP_TIME+MAX_TIME) {
  8018ca:	e8 5b ec ff ff       	call   80052a <gettime_msec>
  8018cf:	89 44 24 18          	mov    %eax,0x18(%esp)
  8018d3:	81 7c 24 18 78 05 00 	cmpl   $0x578,0x18(%esp)
  8018da:	00 
  8018db:	7e 3f                	jle    80191c <main+0x147>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  8018dd:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018e1:	8b 1c 85 48 31 80 00 	mov    0x803148(,%eax,4),%ebx
  8018e8:	e8 fd eb ff ff       	call   8004ea <getpid>
  8018ed:	8b 54 24 18          	mov    0x18(%esp),%edx
  8018f1:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8018f5:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8018f9:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018fd:	c7 04 24 48 1f 80 00 	movl   $0x801f48,(%esp)
  801904:	e8 c0 ee ff ff       	call   8007c9 <cprintf>
                            exit(acc[i]);
  801909:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80190d:	8b 04 85 48 31 80 00 	mov    0x803148(,%eax,4),%eax
  801914:	89 04 24             	mov    %eax,(%esp)
  801917:	e8 4c eb ff ff       	call   800468 <exit>
                        }
                    }
               }
  80191c:	e9 64 ff ff ff       	jmp    801885 <main+0xb0>
               
          }
          if (pids[i] < 0) {
  801921:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801925:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  80192c:	85 c0                	test   %eax,%eax
  80192e:	79 0e                	jns    80193e <main+0x169>
               goto failed;
  801930:	90                   	nop
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801931:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801938:	00 
  801939:	e9 32 01 00 00       	jmp    801a70 <main+0x29b>
     for (i = 0; i < TOTAL; i ++) {
  80193e:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801943:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801948:	0f 8e e7 fe ff ff    	jle    801835 <main+0x60>
     cprintf("main: fork ok,now need to wait pids.\n");
  80194e:	c7 04 24 68 1f 80 00 	movl   $0x801f68,(%esp)
  801955:	e8 6f ee ff ff       	call   8007c9 <cprintf>
     for (i = 0; i < TOTAL; i ++) {
  80195a:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801961:	00 
  801962:	eb 6b                	jmp    8019cf <main+0x1fa>
         status[i]=0;
  801964:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801968:	c7 04 85 5c 31 80 00 	movl   $0x0,0x80315c(,%eax,4)
  80196f:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  801973:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801977:	c1 e0 02             	shl    $0x2,%eax
  80197a:	8d 90 5c 31 80 00    	lea    0x80315c(%eax),%edx
  801980:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801984:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  80198b:	89 54 24 04          	mov    %edx,0x4(%esp)
  80198f:	89 04 24             	mov    %eax,(%esp)
  801992:	e8 19 eb ff ff       	call   8004b0 <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  801997:	e8 8e eb ff ff       	call   80052a <gettime_msec>
  80199c:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8019a0:	8b 0c 95 5c 31 80 00 	mov    0x80315c(,%edx,4),%ecx
  8019a7:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8019ab:	8b 14 95 70 31 80 00 	mov    0x803170(,%edx,4),%edx
  8019b2:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8019b6:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  8019ba:	89 54 24 04          	mov    %edx,0x4(%esp)
  8019be:	c7 04 24 90 1f 80 00 	movl   $0x801f90,(%esp)
  8019c5:	e8 ff ed ff ff       	call   8007c9 <cprintf>
     for (i = 0; i < TOTAL; i ++) {
  8019ca:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8019cf:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  8019d4:	7e 8e                	jle    801964 <main+0x18f>
     cprintf("main: wait pids over\n");
  8019d6:	c7 04 24 af 1f 80 00 	movl   $0x801faf,(%esp)
  8019dd:	e8 e7 ed ff ff       	call   8007c9 <cprintf>
     cprintf("stride sched correct result:");
  8019e2:	c7 04 24 c5 1f 80 00 	movl   $0x801fc5,(%esp)
  8019e9:	e8 db ed ff ff       	call   8007c9 <cprintf>
     for (i = 0; i < TOTAL; i ++)
  8019ee:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8019f5:	00 
  8019f6:	eb 37                	jmp    801a2f <main+0x25a>
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  8019f8:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8019fc:	8b 04 85 5c 31 80 00 	mov    0x80315c(,%eax,4),%eax
  801a03:	01 c0                	add    %eax,%eax
  801a05:	8b 35 5c 31 80 00    	mov    0x80315c,%esi
  801a0b:	99                   	cltd   
  801a0c:	f7 fe                	idiv   %esi
  801a0e:	83 c0 01             	add    $0x1,%eax
  801a11:	89 c2                	mov    %eax,%edx
  801a13:	c1 ea 1f             	shr    $0x1f,%edx
  801a16:	01 d0                	add    %edx,%eax
  801a18:	d1 f8                	sar    %eax
  801a1a:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a1e:	c7 04 24 e2 1f 80 00 	movl   $0x801fe2,(%esp)
  801a25:	e8 9f ed ff ff       	call   8007c9 <cprintf>
     for (i = 0; i < TOTAL; i ++)
  801a2a:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a2f:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801a34:	7e c2                	jle    8019f8 <main+0x223>
     cprintf("\n");
  801a36:	c7 04 24 e6 1f 80 00 	movl   $0x801fe6,(%esp)
  801a3d:	e8 87 ed ff ff       	call   8007c9 <cprintf>
     return 0;
  801a42:	b8 00 00 00 00       	mov    $0x0,%eax
  801a47:	eb 4a                	jmp    801a93 <main+0x2be>
          if (pids[i] > 0) {
  801a49:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a4d:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801a54:	85 c0                	test   %eax,%eax
  801a56:	7e 13                	jle    801a6b <main+0x296>
               kill(pids[i]);
  801a58:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a5c:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801a63:	89 04 24             	mov    %eax,(%esp)
  801a66:	e8 6c ea ff ff       	call   8004d7 <kill>
     for (i = 0; i < TOTAL; i ++) {
  801a6b:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a70:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801a75:	7e d2                	jle    801a49 <main+0x274>
          }
     }
     panic("FAIL: T.T\n");
  801a77:	c7 44 24 08 e8 1f 80 	movl   $0x801fe8,0x8(%esp)
  801a7e:	00 
  801a7f:	c7 44 24 04 4e 00 00 	movl   $0x4e,0x4(%esp)
  801a86:	00 
  801a87:	c7 04 24 f3 1f 80 00 	movl   $0x801ff3,(%esp)
  801a8e:	e8 8d e5 ff ff       	call   800020 <__panic>
}
