...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 00 19 80 00 	movl   $0x801900,(%esp)
  ...
  800053:	e8 36 07 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 1a 19 80 00 	movl   $0x80191a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 1c 19 80 00 	movl   $0x80191c,(%esp)
  ...
  8000a3:	e8 e6 06 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 1a 19 80 00 	movl   $0x80191a,(%esp)
...
exit(int error_code) {
  ...
  800479:	c7 04 24 38 19 80 00 	movl   $0x801938,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800700:	c7 04 24 4b 19 80 00 	movl   $0x80194b,(%esp)
  ...
  80071e:	c7 04 24 56 19 80 00 	movl   $0x801956,(%esp)
  ...
  800734:	c7 04 24 68 19 80 00 	movl   $0x801968,(%esp)
  ...
  80074a:	c7 04 24 7b 19 80 00 	movl   $0x80197b,(%esp)
  ...
  800760:	c7 04 24 8e 19 80 00 	movl   $0x80198e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a1d:	00 
  800a1e:	c7 44 24 04 a1 19 80 	movl   $0x8019a1,0x4(%esp)
  800a25:	00 
  ...
  800a42:	c7 44 24 08 a8 19 80 	movl   $0x8019a8,0x8(%esp)
  800a49:	00 
  800a4a:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a51:	00 
  800a52:	c7 04 24 c2 19 80 00 	movl   $0x8019c2,(%esp)
  800a59:	e8 12 f6 ff ff       	call   800070 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a5e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a65:	00 
  800a66:	c7 44 24 04 d4 19 80 	movl   $0x8019d4,0x4(%esp)
  800a6d:	00 
  ...
  800a8a:	c7 44 24 08 dc 19 80 	movl   $0x8019dc,0x8(%esp)
  800a91:	00 
  800a92:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800a99:	00 
  800a9a:	c7 04 24 c2 19 80 00 	movl   $0x8019c2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  80109c:	05 04 1c 80 00       	add    $0x801c04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  801200:	8b 04 85 28 1c 80 00 	mov    0x801c28(,%eax,4),%eax
  ...
  801319:	c7 44 24 0c 1e 1c 80 	movl   $0x801c1e,0xc(%esp)
  801320:	00 
  ...
  80134c:	75 05                	jne    801353 <vprintfmt+0x1c9>
                p = "(null)";
  80134e:	be 21 1c 80 00       	mov    $0x801c21,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017af:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  8017b2:	e8 d0 ec ff ff       	call   800487 <fork>
  8017b7:	89 44 24 18          	mov    %eax,0x18(%esp)
  8017bb:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8017c0:	75 33                	jne    8017f5 <main+0x4c>
        cprintf("fork ok.\n");
  8017c2:	c7 04 24 80 1d 80 00 	movl   $0x801d80,(%esp)
  8017c9:	e8 fb ef ff ff       	call   8007c9 <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  8017ce:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8017d5:	00 
  8017d6:	eb 0a                	jmp    8017e2 <main+0x39>
            yield();
  8017d8:	e8 ed ec ff ff       	call   8004ca <yield>
        for (i = 0; i < 10; i ++) {
  8017dd:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8017e2:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  8017e7:	7e ef                	jle    8017d8 <main+0x2f>
        }
        exit(0xbeaf);
  8017e9:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  8017f0:	e8 73 ec ff ff       	call   800468 <exit>
    }
    assert(pid > 0);
  8017f5:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8017fa:	7f 24                	jg     801820 <main+0x77>
  8017fc:	c7 44 24 0c 8a 1d 80 	movl   $0x801d8a,0xc(%esp)
  801803:	00 
  801804:	c7 44 24 08 92 1d 80 	movl   $0x801d92,0x8(%esp)
  80180b:	00 
  80180c:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  801813:	00 
  801814:	c7 04 24 a7 1d 80 00 	movl   $0x801da7,(%esp)
  80181b:	e8 00 e8 ff ff       	call   800020 <__panic>
    assert(waitpid(-1, NULL) != 0);
  801820:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801827:	00 
  801828:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  80182f:	e8 7c ec ff ff       	call   8004b0 <waitpid>
  801834:	85 c0                	test   %eax,%eax
  801836:	75 24                	jne    80185c <main+0xb3>
  801838:	c7 44 24 0c b5 1d 80 	movl   $0x801db5,0xc(%esp)
  80183f:	00 
  801840:	c7 44 24 08 92 1d 80 	movl   $0x801d92,0x8(%esp)
  801847:	00 
  801848:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  80184f:	00 
  801850:	c7 04 24 a7 1d 80 00 	movl   $0x801da7,(%esp)
  801857:	e8 c4 e7 ff ff       	call   800020 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  80185c:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  801863:	c0 
  801864:	8b 44 24 18          	mov    0x18(%esp),%eax
  801868:	89 04 24             	mov    %eax,(%esp)
  80186b:	e8 40 ec ff ff       	call   8004b0 <waitpid>
  801870:	85 c0                	test   %eax,%eax
  801872:	75 24                	jne    801898 <main+0xef>
  801874:	c7 44 24 0c cc 1d 80 	movl   $0x801dcc,0xc(%esp)
  80187b:	00 
  80187c:	c7 44 24 08 92 1d 80 	movl   $0x801d92,0x8(%esp)
  801883:	00 
  801884:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  80188b:	00 
  80188c:	c7 04 24 a7 1d 80 00 	movl   $0x801da7,(%esp)
  801893:	e8 88 e7 ff ff       	call   800020 <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  801898:	8d 44 24 14          	lea    0x14(%esp),%eax
  80189c:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018a0:	8b 44 24 18          	mov    0x18(%esp),%eax
  8018a4:	89 04 24             	mov    %eax,(%esp)
  8018a7:	e8 04 ec ff ff       	call   8004b0 <waitpid>
  8018ac:	85 c0                	test   %eax,%eax
  8018ae:	75 0b                	jne    8018bb <main+0x112>
  8018b0:	8b 44 24 14          	mov    0x14(%esp),%eax
  8018b4:	3d af be 00 00       	cmp    $0xbeaf,%eax
  8018b9:	74 24                	je     8018df <main+0x136>
  8018bb:	c7 44 24 0c f4 1d 80 	movl   $0x801df4,0xc(%esp)
  8018c2:	00 
  8018c3:	c7 44 24 08 92 1d 80 	movl   $0x801d92,0x8(%esp)
  8018ca:	00 
  8018cb:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  8018d2:	00 
  8018d3:	c7 04 24 a7 1d 80 00 	movl   $0x801da7,(%esp)
  8018da:	e8 41 e7 ff ff       	call   800020 <__panic>
    cprintf("badarg pass.\n");
  8018df:	c7 04 24 29 1e 80 00 	movl   $0x801e29,(%esp)
  8018e6:	e8 de ee ff ff       	call   8007c9 <cprintf>
    return 0;
