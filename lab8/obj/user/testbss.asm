...
main(void) {
  ...
  8017be:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8017c5:	00 
  8017c6:	eb 38                	jmp    801800 <main+0x57>
        if (bigarray[i] != 0) {
  8017c8:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8017cc:	8b 04 85 60 21 80 00 	mov    0x802160(,%eax,4),%eax
  8017d3:	85 c0                	test   %eax,%eax
  8017d5:	74 24                	je     8017fb <main+0x52>
            panic("bigarray[%d] isn't cleared!\n", i);
  8017d7:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8017db:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8017df:	c7 44 24 08 80 1d 80 	movl   $0x801d80,0x8(%esp)
  8017e6:	00 
  8017e7:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  8017ee:	00 
  8017ef:	c7 04 24 9d 1d 80 00 	movl   $0x801d9d,(%esp)
  8017f6:	e8 25 e8 ff ff       	call   800020 <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  8017fb:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801800:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801807:	00 
  801808:	7e be                	jle    8017c8 <main+0x1f>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80180a:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801811:	00 
  801812:	eb 14                	jmp    801828 <main+0x7f>
        bigarray[i] = i;
  801814:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801818:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80181c:	89 14 85 60 21 80 00 	mov    %edx,0x802160(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  801823:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801828:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  80182f:	00 
  801830:	7e e2                	jle    801814 <main+0x6b>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801832:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801839:	00 
  80183a:	eb 3c                	jmp    801878 <main+0xcf>
        if (bigarray[i] != i) {
  80183c:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801840:	8b 14 85 60 21 80 00 	mov    0x802160(,%eax,4),%edx
  801847:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80184b:	39 c2                	cmp    %eax,%edx
  80184d:	74 24                	je     801873 <main+0xca>
            panic("bigarray[%d] didn't hold its value!\n", i);
  80184f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801853:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801857:	c7 44 24 08 ac 1d 80 	movl   $0x801dac,0x8(%esp)
  80185e:	00 
  80185f:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  801866:	00 
  801867:	c7 04 24 9d 1d 80 00 	movl   $0x801d9d,(%esp)
  80186e:	e8 ad e7 ff ff       	call   800020 <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  801873:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801878:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  80187f:	00 
  801880:	7e ba                	jle    80183c <main+0x93>
        }
    }

    cprintf("Yes, good.  Now doing a wild write off the end...\n");
  801882:	c7 04 24 d4 1d 80 00 	movl   $0x801dd4,(%esp)
  801889:	e8 3b ef ff ff       	call   8007c9 <cprintf>
    cprintf("testbss may pass.\n");
  80188e:	c7 04 24 07 1e 80 00 	movl   $0x801e07,(%esp)
  801895:	e8 2f ef ff ff       	call   8007c9 <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  80189a:	c7 05 60 31 c0 00 00 	movl   $0x0,0xc03160
  8018a1:	00 00 00 
    asm volatile ("int $0x14");
  8018a4:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  8018a6:	c7 44 24 08 1a 1e 80 	movl   $0x801e1a,0x8(%esp)
  8018ad:	00 
  8018ae:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  8018b5:	00 
  8018b6:	c7 04 24 9d 1d 80 00 	movl   $0x801d9d,(%esp)
  8018bd:	e8 5e e7 ff ff       	call   800020 <__panic>
