...
main(void) {
  ...
  8017af:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  8017b2:	c7 04 24 80 1c 80 00 	movl   $0x801c80,(%esp)
  8017b9:	e8 0b f0 ff ff       	call   8007c9 <cprintf>
    cprintf("I am process %d.\n", getpid());
  8017be:	e8 27 ed ff ff       	call   8004ea <getpid>
  8017c3:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017c7:	c7 04 24 90 1c 80 00 	movl   $0x801c90,(%esp)
  8017ce:	e8 f6 ef ff ff       	call   8007c9 <cprintf>
    cprintf("hello pass.\n");
  8017d3:	c7 04 24 a2 1c 80 00 	movl   $0x801ca2,(%esp)
  8017da:	e8 ea ef ff ff       	call   8007c9 <cprintf>
    return 0;
