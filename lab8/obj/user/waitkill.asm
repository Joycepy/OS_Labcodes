...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 40 19 80 00 	movl   $0x801940,(%esp)
  ...
  800053:	e8 36 07 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 5a 19 80 00 	movl   $0x80195a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 5c 19 80 00 	movl   $0x80195c,(%esp)
  ...
  8000a3:	e8 e6 06 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 5a 19 80 00 	movl   $0x80195a,(%esp)
...
exit(int error_code) {
  ...
  800479:	c7 04 24 78 19 80 00 	movl   $0x801978,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800700:	c7 04 24 8b 19 80 00 	movl   $0x80198b,(%esp)
  ...
  80071e:	c7 04 24 96 19 80 00 	movl   $0x801996,(%esp)
  ...
  800734:	c7 04 24 a8 19 80 00 	movl   $0x8019a8,(%esp)
  ...
  80074a:	c7 04 24 bb 19 80 00 	movl   $0x8019bb,(%esp)
  ...
  800760:	c7 04 24 ce 19 80 00 	movl   $0x8019ce,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a1d:	00 
  800a1e:	c7 44 24 04 e1 19 80 	movl   $0x8019e1,0x4(%esp)
  800a25:	00 
  ...
  800a42:	c7 44 24 08 e8 19 80 	movl   $0x8019e8,0x8(%esp)
  800a49:	00 
  800a4a:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a51:	00 
  800a52:	c7 04 24 02 1a 80 00 	movl   $0x801a02,(%esp)
  800a59:	e8 12 f6 ff ff       	call   800070 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a5e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a65:	00 
  800a66:	c7 44 24 04 14 1a 80 	movl   $0x801a14,0x4(%esp)
  800a6d:	00 
  ...
  800a8a:	c7 44 24 08 1c 1a 80 	movl   $0x801a1c,0x8(%esp)
  800a91:	00 
  800a92:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800a99:	00 
  800a9a:	c7 04 24 02 1a 80 00 	movl   $0x801a02,(%esp)
  ...
  800ab3:	e8 99 0d 00 00       	call   801851 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  80109c:	05 44 1c 80 00       	add    $0x801c44,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  801200:	8b 04 85 68 1c 80 00 	mov    0x801c68(,%eax,4),%eax
  ...
  801319:	c7 44 24 0c 5e 1c 80 	movl   $0x801c5e,0xc(%esp)
  801320:	00 
  ...
  80134c:	75 05                	jne    801353 <vprintfmt+0x1c9>
                p = "(null)";
  80134e:	be 61 1c 80 00       	mov    $0x801c61,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  8017ac:	83 ec 08             	sub    $0x8,%esp
    yield();
  8017af:	e8 16 ed ff ff       	call   8004ca <yield>
    yield();
  8017b4:	e8 11 ed ff ff       	call   8004ca <yield>
    yield();
  8017b9:	e8 0c ed ff ff       	call   8004ca <yield>
    yield();
  8017be:	e8 07 ed ff ff       	call   8004ca <yield>
    yield();
  8017c3:	e8 02 ed ff ff       	call   8004ca <yield>
    yield();
  8017c8:	e8 fd ec ff ff       	call   8004ca <yield>
}
  8017cd:	c9                   	leave  
  8017ce:	c3                   	ret    
...
loop(void) {
  ...
  8017d2:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  8017d5:	c7 04 24 c0 1d 80 00 	movl   $0x801dc0,(%esp)
  8017dc:	e8 e8 ef ff ff       	call   8007c9 <cprintf>
    while (1);
  8017e1:	eb fe                	jmp    8017e1 <loop+0x12>
...
work(void) {
  ...
  8017e6:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  8017e9:	c7 04 24 ca 1d 80 00 	movl   $0x801dca,(%esp)
  8017f0:	e8 d4 ef ff ff       	call   8007c9 <cprintf>
    do_yield();
  8017f5:	e8 af ff ff ff       	call   8017a9 <do_yield>
    if (kill(parent) == 0) {
  8017fa:	a1 48 21 80 00       	mov    0x802148,%eax
  8017ff:	89 04 24             	mov    %eax,(%esp)
  801802:	e8 d0 ec ff ff       	call   8004d7 <kill>
  801807:	85 c0                	test   %eax,%eax
  801809:	75 3a                	jne    801845 <work+0x62>
        cprintf("kill parent ok.\n");
  80180b:	c7 04 24 d4 1d 80 00 	movl   $0x801dd4,(%esp)
  801812:	e8 b2 ef ff ff       	call   8007c9 <cprintf>
        do_yield();
  801817:	e8 8d ff ff ff       	call   8017a9 <do_yield>
        if (kill(pid1) == 0) {
  80181c:	a1 50 21 80 00       	mov    0x802150,%eax
  801821:	89 04 24             	mov    %eax,(%esp)
  801824:	e8 ae ec ff ff       	call   8004d7 <kill>
  801829:	85 c0                	test   %eax,%eax
  80182b:	75 18                	jne    801845 <work+0x62>
            cprintf("kill child1 ok.\n");
  80182d:	c7 04 24 e5 1d 80 00 	movl   $0x801de5,(%esp)
  801834:	e8 90 ef ff ff       	call   8007c9 <cprintf>
            exit(0);
  801839:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801840:	e8 23 ec ff ff       	call   800468 <exit>
        }
    }
    exit(-1);
  801845:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  80184c:	e8 17 ec ff ff       	call   800468 <exit>
...
main(void) {
  ...
  801854:	83 e4 f0             	and    $0xfffffff0,%esp
  801857:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  80185a:	e8 8b ec ff ff       	call   8004ea <getpid>
  80185f:	a3 48 21 80 00       	mov    %eax,0x802148
    if ((pid1 = fork()) == 0) {
  801864:	e8 1e ec ff ff       	call   800487 <fork>
  801869:	a3 50 21 80 00       	mov    %eax,0x802150
  80186e:	a1 50 21 80 00       	mov    0x802150,%eax
  801873:	85 c0                	test   %eax,%eax
  801875:	75 05                	jne    80187c <main+0x2b>
        loop();
  801877:	e8 53 ff ff ff       	call   8017cf <loop>
    }

    assert(pid1 > 0);
  80187c:	a1 50 21 80 00       	mov    0x802150,%eax
  801881:	85 c0                	test   %eax,%eax
  801883:	7f 24                	jg     8018a9 <main+0x58>
  801885:	c7 44 24 0c f6 1d 80 	movl   $0x801df6,0xc(%esp)
  80188c:	00 
  80188d:	c7 44 24 08 ff 1d 80 	movl   $0x801dff,0x8(%esp)
  801894:	00 
  801895:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  80189c:	00 
  80189d:	c7 04 24 14 1e 80 00 	movl   $0x801e14,(%esp)
  8018a4:	e8 77 e7 ff ff       	call   800020 <__panic>

    if ((pid2 = fork()) == 0) {
  8018a9:	e8 d9 eb ff ff       	call   800487 <fork>
  8018ae:	a3 4c 21 80 00       	mov    %eax,0x80214c
  8018b3:	a1 4c 21 80 00       	mov    0x80214c,%eax
  8018b8:	85 c0                	test   %eax,%eax
  8018ba:	75 05                	jne    8018c1 <main+0x70>
        work();
  8018bc:	e8 22 ff ff ff       	call   8017e3 <work>
    }
    if (pid2 > 0) {
  8018c1:	a1 4c 21 80 00       	mov    0x80214c,%eax
  8018c6:	85 c0                	test   %eax,%eax
  8018c8:	7e 46                	jle    801910 <main+0xbf>
        cprintf("wait child 1.\n");
  8018ca:	c7 04 24 24 1e 80 00 	movl   $0x801e24,(%esp)
  8018d1:	e8 f3 ee ff ff       	call   8007c9 <cprintf>
        waitpid(pid1, NULL);
  8018d6:	a1 50 21 80 00       	mov    0x802150,%eax
  8018db:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8018e2:	00 
  8018e3:	89 04 24             	mov    %eax,(%esp)
  8018e6:	e8 c5 eb ff ff       	call   8004b0 <waitpid>
        panic("waitpid %d returns\n", pid1);
  8018eb:	a1 50 21 80 00       	mov    0x802150,%eax
  8018f0:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8018f4:	c7 44 24 08 33 1e 80 	movl   $0x801e33,0x8(%esp)
  8018fb:	00 
  8018fc:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  801903:	00 
  801904:	c7 04 24 14 1e 80 00 	movl   $0x801e14,(%esp)
  80190b:	e8 10 e7 ff ff       	call   800020 <__panic>
    }
    else {
        kill(pid1);
  801910:	a1 50 21 80 00       	mov    0x802150,%eax
  801915:	89 04 24             	mov    %eax,(%esp)
  801918:	e8 ba eb ff ff       	call   8004d7 <kill>
    }
    panic("FAIL: T.T\n");
  80191d:	c7 44 24 08 47 1e 80 	movl   $0x801e47,0x8(%esp)
  801924:	00 
  801925:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  80192c:	00 
  80192d:	c7 04 24 14 1e 80 00 	movl   $0x801e14,(%esp)
  801934:	e8 e7 e6 ff ff       	call   800020 <__panic>
