...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 60 18 80 00 	movl   $0x801860,(%esp)
  ...
  800053:	e8 36 07 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 7a 18 80 00 	movl   $0x80187a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 7c 18 80 00 	movl   $0x80187c,(%esp)
  ...
  8000a3:	e8 e6 06 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 7a 18 80 00 	movl   $0x80187a,(%esp)
...
exit(int error_code) {
  ...
  800479:	c7 04 24 98 18 80 00 	movl   $0x801898,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800700:	c7 04 24 ab 18 80 00 	movl   $0x8018ab,(%esp)
  ...
  80071e:	c7 04 24 b6 18 80 00 	movl   $0x8018b6,(%esp)
  ...
  800734:	c7 04 24 c8 18 80 00 	movl   $0x8018c8,(%esp)
  ...
  80074a:	c7 04 24 db 18 80 00 	movl   $0x8018db,(%esp)
  ...
  800760:	c7 04 24 ee 18 80 00 	movl   $0x8018ee,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a1d:	00 
  800a1e:	c7 44 24 04 01 19 80 	movl   $0x801901,0x4(%esp)
  800a25:	00 
  ...
  800a42:	c7 44 24 08 08 19 80 	movl   $0x801908,0x8(%esp)
  800a49:	00 
  800a4a:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a51:	00 
  800a52:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  800a59:	e8 12 f6 ff ff       	call   800070 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a5e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a65:	00 
  800a66:	c7 44 24 04 34 19 80 	movl   $0x801934,0x4(%esp)
  800a6d:	00 
  ...
  800a8a:	c7 44 24 08 3c 19 80 	movl   $0x80193c,0x8(%esp)
  800a91:	00 
  800a92:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800a99:	00 
  800a9a:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  80109c:	05 64 1b 80 00       	add    $0x801b64,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  801200:	8b 04 85 88 1b 80 00 	mov    0x801b88(,%eax,4),%eax
  ...
  801319:	c7 44 24 0c 7e 1b 80 	movl   $0x801b7e,0xc(%esp)
  801320:	00 
  ...
  80134c:	75 05                	jne    801353 <vprintfmt+0x1c9>
                p = "(null)";
  80134e:	be 81 1b 80 00       	mov    $0x801b81,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017b7:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8017bb:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8017c0:	75 18                	jne    8017da <main+0x31>
        sleep(~0);
  8017c2:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  8017c9:	e8 49 ed ff ff       	call   800517 <sleep>
        exit(0xdead);
  8017ce:	c7 04 24 ad de 00 00 	movl   $0xdead,(%esp)
  8017d5:	e8 8e ec ff ff       	call   800468 <exit>
    }
    assert(pid > 0);
  8017da:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8017df:	7f 24                	jg     801805 <main+0x5c>
  8017e1:	c7 44 24 0c e0 1c 80 	movl   $0x801ce0,0xc(%esp)
  8017e8:	00 
  8017e9:	c7 44 24 08 e8 1c 80 	movl   $0x801ce8,0x8(%esp)
  8017f0:	00 
  8017f1:	c7 44 24 04 0b 00 00 	movl   $0xb,0x4(%esp)
  8017f8:	00 
  8017f9:	c7 04 24 fd 1c 80 00 	movl   $0x801cfd,(%esp)
  801800:	e8 1b e8 ff ff       	call   800020 <__panic>

    sleep(100);
  801805:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  80180c:	e8 06 ed ff ff       	call   800517 <sleep>
    assert(kill(pid) == 0);
  801811:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801815:	89 04 24             	mov    %eax,(%esp)
  801818:	e8 ba ec ff ff       	call   8004d7 <kill>
  80181d:	85 c0                	test   %eax,%eax
  80181f:	74 24                	je     801845 <main+0x9c>
  801821:	c7 44 24 0c 0e 1d 80 	movl   $0x801d0e,0xc(%esp)
  801828:	00 
  801829:	c7 44 24 08 e8 1c 80 	movl   $0x801ce8,0x8(%esp)
  801830:	00 
  801831:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801838:	00 
  801839:	c7 04 24 fd 1c 80 00 	movl   $0x801cfd,(%esp)
  801840:	e8 db e7 ff ff       	call   800020 <__panic>
    cprintf("sleepkill pass.\n");
  801845:	c7 04 24 1d 1d 80 00 	movl   $0x801d1d,(%esp)
  80184c:	e8 78 ef ff ff       	call   8007c9 <cprintf>
    return 0;
