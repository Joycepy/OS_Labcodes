...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 a0 18 80 00 	movl   $0x8018a0,(%esp)
  ...
  800053:	e8 36 07 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 ba 18 80 00 	movl   $0x8018ba,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 bc 18 80 00 	movl   $0x8018bc,(%esp)
  ...
  8000a3:	e8 e6 06 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 ba 18 80 00 	movl   $0x8018ba,(%esp)
...
exit(int error_code) {
  ...
  800479:	c7 04 24 d8 18 80 00 	movl   $0x8018d8,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800700:	c7 04 24 eb 18 80 00 	movl   $0x8018eb,(%esp)
  ...
  80071e:	c7 04 24 f6 18 80 00 	movl   $0x8018f6,(%esp)
  ...
  800734:	c7 04 24 08 19 80 00 	movl   $0x801908,(%esp)
  ...
  80074a:	c7 04 24 1b 19 80 00 	movl   $0x80191b,(%esp)
  ...
  800760:	c7 04 24 2e 19 80 00 	movl   $0x80192e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a1d:	00 
  800a1e:	c7 44 24 04 41 19 80 	movl   $0x801941,0x4(%esp)
  800a25:	00 
  ...
  800a42:	c7 44 24 08 48 19 80 	movl   $0x801948,0x8(%esp)
  800a49:	00 
  800a4a:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a51:	00 
  800a52:	c7 04 24 62 19 80 00 	movl   $0x801962,(%esp)
  800a59:	e8 12 f6 ff ff       	call   800070 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a5e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a65:	00 
  800a66:	c7 44 24 04 74 19 80 	movl   $0x801974,0x4(%esp)
  800a6d:	00 
  ...
  800a8a:	c7 44 24 08 7c 19 80 	movl   $0x80197c,0x8(%esp)
  800a91:	00 
  800a92:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800a99:	00 
  800a9a:	c7 04 24 62 19 80 00 	movl   $0x801962,(%esp)
  ...
  800ab3:	e8 45 0d 00 00       	call   8017fd <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  80109c:	05 a4 1b 80 00       	add    $0x801ba4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  801200:	8b 04 85 c8 1b 80 00 	mov    0x801bc8(,%eax,4),%eax
  ...
  801319:	c7 44 24 0c be 1b 80 	movl   $0x801bbe,0xc(%esp)
  801320:	00 
  ...
  80134c:	75 05                	jne    801353 <vprintfmt+0x1c9>
                p = "(null)";
  80134e:	be c1 1b 80 00       	mov    $0x801bc1,%esi
            }
            if (width > 0 && padc != '-') {
...
sleepy(int pid) {
  ...
  8017ac:	83 ec 28             	sub    $0x28,%esp
    int i, time = 100;
  8017af:	c7 45 f0 64 00 00 00 	movl   $0x64,-0x10(%ebp)
    for (i = 0; i < 10; i ++) {
  8017b6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8017bd:	eb 2c                	jmp    8017eb <sleepy+0x42>
        sleep(time);
  8017bf:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8017c2:	89 04 24             	mov    %eax,(%esp)
  8017c5:	e8 4d ed ff ff       	call   800517 <sleep>
        cprintf("sleep %d x %d slices.\n", i + 1, time);
  8017ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017cd:	8d 50 01             	lea    0x1(%eax),%edx
  8017d0:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8017d3:	89 44 24 08          	mov    %eax,0x8(%esp)
  8017d7:	89 54 24 04          	mov    %edx,0x4(%esp)
  8017db:	c7 04 24 20 1d 80 00 	movl   $0x801d20,(%esp)
  8017e2:	e8 e2 ef ff ff       	call   8007c9 <cprintf>
    for (i = 0; i < 10; i ++) {
  8017e7:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8017eb:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  8017ef:	7e ce                	jle    8017bf <sleepy+0x16>
    }
    exit(0);
  8017f1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8017f8:	e8 6b ec ff ff       	call   800468 <exit>
...
main(void) {
  ...
  801800:	83 e4 f0             	and    $0xfffffff0,%esp
  801803:	83 ec 20             	sub    $0x20,%esp
    unsigned int time = gettime_msec();
  801806:	e8 1f ed ff ff       	call   80052a <gettime_msec>
  80180b:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  80180f:	e8 73 ec ff ff       	call   800487 <fork>
  801814:	89 44 24 18          	mov    %eax,0x18(%esp)
  801818:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80181d:	75 0c                	jne    80182b <main+0x2e>
        sleepy(pid1);
  80181f:	8b 44 24 18          	mov    0x18(%esp),%eax
  801823:	89 04 24             	mov    %eax,(%esp)
  801826:	e8 7e ff ff ff       	call   8017a9 <sleepy>
    }
    
    assert(waitpid(pid1, &exit_code) == 0 && exit_code == 0);
  80182b:	8d 44 24 14          	lea    0x14(%esp),%eax
  80182f:	89 44 24 04          	mov    %eax,0x4(%esp)
  801833:	8b 44 24 18          	mov    0x18(%esp),%eax
  801837:	89 04 24             	mov    %eax,(%esp)
  80183a:	e8 71 ec ff ff       	call   8004b0 <waitpid>
  80183f:	85 c0                	test   %eax,%eax
  801841:	75 08                	jne    80184b <main+0x4e>
  801843:	8b 44 24 14          	mov    0x14(%esp),%eax
  801847:	85 c0                	test   %eax,%eax
  801849:	74 24                	je     80186f <main+0x72>
  80184b:	c7 44 24 0c 38 1d 80 	movl   $0x801d38,0xc(%esp)
  801852:	00 
  801853:	c7 44 24 08 69 1d 80 	movl   $0x801d69,0x8(%esp)
  80185a:	00 
  80185b:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801862:	00 
  801863:	c7 04 24 7e 1d 80 00 	movl   $0x801d7e,(%esp)
  80186a:	e8 b1 e7 ff ff       	call   800020 <__panic>
    cprintf("use %04d msecs.\n", gettime_msec() - time);
  80186f:	e8 b6 ec ff ff       	call   80052a <gettime_msec>
  801874:	2b 44 24 1c          	sub    0x1c(%esp),%eax
  801878:	89 44 24 04          	mov    %eax,0x4(%esp)
  80187c:	c7 04 24 8b 1d 80 00 	movl   $0x801d8b,(%esp)
  801883:	e8 41 ef ff ff       	call   8007c9 <cprintf>
    cprintf("sleep pass.\n");
  801888:	c7 04 24 9c 1d 80 00 	movl   $0x801d9c,(%esp)
  80188f:	e8 35 ef ff ff       	call   8007c9 <cprintf>
    return 0;
