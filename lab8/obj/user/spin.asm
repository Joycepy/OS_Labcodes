...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 e0 18 80 00 	movl   $0x8018e0,(%esp)
  ...
  800053:	e8 36 07 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 fa 18 80 00 	movl   $0x8018fa,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 fc 18 80 00 	movl   $0x8018fc,(%esp)
  ...
  8000a3:	e8 e6 06 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 fa 18 80 00 	movl   $0x8018fa,(%esp)
...
exit(int error_code) {
  ...
  800479:	c7 04 24 18 19 80 00 	movl   $0x801918,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800700:	c7 04 24 2b 19 80 00 	movl   $0x80192b,(%esp)
  ...
  80071e:	c7 04 24 36 19 80 00 	movl   $0x801936,(%esp)
  ...
  800734:	c7 04 24 48 19 80 00 	movl   $0x801948,(%esp)
  ...
  80074a:	c7 04 24 5b 19 80 00 	movl   $0x80195b,(%esp)
  ...
  800760:	c7 04 24 6e 19 80 00 	movl   $0x80196e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a1d:	00 
  800a1e:	c7 44 24 04 81 19 80 	movl   $0x801981,0x4(%esp)
  800a25:	00 
  ...
  800a42:	c7 44 24 08 88 19 80 	movl   $0x801988,0x8(%esp)
  800a49:	00 
  800a4a:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a51:	00 
  800a52:	c7 04 24 a2 19 80 00 	movl   $0x8019a2,(%esp)
  800a59:	e8 12 f6 ff ff       	call   800070 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a5e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a65:	00 
  800a66:	c7 44 24 04 b4 19 80 	movl   $0x8019b4,0x4(%esp)
  800a6d:	00 
  ...
  800a8a:	c7 44 24 08 bc 19 80 	movl   $0x8019bc,0x8(%esp)
  800a91:	00 
  800a92:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800a99:	00 
  800a9a:	c7 04 24 a2 19 80 00 	movl   $0x8019a2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  80109c:	05 e4 1b 80 00       	add    $0x801be4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  801200:	8b 04 85 08 1c 80 00 	mov    0x801c08(,%eax,4),%eax
  ...
  801319:	c7 44 24 0c fe 1b 80 	movl   $0x801bfe,0xc(%esp)
  801320:	00 
  ...
  80134c:	75 05                	jne    801353 <vprintfmt+0x1c9>
                p = "(null)";
  80134e:	be 01 1c 80 00       	mov    $0x801c01,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017b2:	c7 04 24 60 1d 80 00 	movl   $0x801d60,(%esp)
  ...
  8017ce:	c7 04 24 87 1d 80 00 	movl   $0x801d87,(%esp)
  8017d5:	e8 ef ef ff ff       	call   8007c9 <cprintf>
        while (1);
  8017da:	eb fe                	jmp    8017da <main+0x31>
    }else if (pid<0) {
  8017dc:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8017e1:	79 1c                	jns    8017ff <main+0x56>
        panic("fork child error\n");
  8017e3:	c7 44 24 08 a5 1d 80 	movl   $0x801da5,0x8(%esp)
  8017ea:	00 
  8017eb:	c7 44 24 04 0d 00 00 	movl   $0xd,0x4(%esp)
  8017f2:	00 
  8017f3:	c7 04 24 b7 1d 80 00 	movl   $0x801db7,(%esp)
  8017fa:	e8 21 e8 ff ff       	call   800020 <__panic>
    }
    cprintf("I am the parent. Running the child...\n");
  8017ff:	c7 04 24 c4 1d 80 00 	movl   $0x801dc4,(%esp)
  801806:	e8 be ef ff ff       	call   8007c9 <cprintf>

    yield();
  80180b:	e8 ba ec ff ff       	call   8004ca <yield>
    yield();
  801810:	e8 b5 ec ff ff       	call   8004ca <yield>
    yield();
  801815:	e8 b0 ec ff ff       	call   8004ca <yield>
    
    cprintf("I am the parent.  Killing the child...\n");
  80181a:	c7 04 24 ec 1d 80 00 	movl   $0x801dec,(%esp)
  801821:	e8 a3 ef ff ff       	call   8007c9 <cprintf>

    assert((ret = kill(pid)) == 0);
  801826:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80182a:	89 04 24             	mov    %eax,(%esp)
  80182d:	e8 a5 ec ff ff       	call   8004d7 <kill>
  801832:	89 44 24 18          	mov    %eax,0x18(%esp)
  801836:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80183b:	74 24                	je     801861 <main+0xb8>
  80183d:	c7 44 24 0c 14 1e 80 	movl   $0x801e14,0xc(%esp)
  801844:	00 
  801845:	c7 44 24 08 2b 1e 80 	movl   $0x801e2b,0x8(%esp)
  80184c:	00 
  80184d:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801854:	00 
  801855:	c7 04 24 b7 1d 80 00 	movl   $0x801db7,(%esp)
  80185c:	e8 bf e7 ff ff       	call   800020 <__panic>
    cprintf("kill returns %d\n", ret);
  801861:	8b 44 24 18          	mov    0x18(%esp),%eax
  801865:	89 44 24 04          	mov    %eax,0x4(%esp)
  801869:	c7 04 24 40 1e 80 00 	movl   $0x801e40,(%esp)
  801870:	e8 54 ef ff ff       	call   8007c9 <cprintf>

    assert((ret = waitpid(pid, NULL)) == 0);
  801875:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80187c:	00 
  80187d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801881:	89 04 24             	mov    %eax,(%esp)
  801884:	e8 27 ec ff ff       	call   8004b0 <waitpid>
  801889:	89 44 24 18          	mov    %eax,0x18(%esp)
  80188d:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801892:	74 24                	je     8018b8 <main+0x10f>
  801894:	c7 44 24 0c 54 1e 80 	movl   $0x801e54,0xc(%esp)
  80189b:	00 
  80189c:	c7 44 24 08 2b 1e 80 	movl   $0x801e2b,0x8(%esp)
  8018a3:	00 
  8018a4:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  8018ab:	00 
  8018ac:	c7 04 24 b7 1d 80 00 	movl   $0x801db7,(%esp)
  8018b3:	e8 68 e7 ff ff       	call   800020 <__panic>
    cprintf("wait returns %d\n", ret);
  8018b8:	8b 44 24 18          	mov    0x18(%esp),%eax
  8018bc:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018c0:	c7 04 24 74 1e 80 00 	movl   $0x801e74,(%esp)
  8018c7:	e8 fd ee ff ff       	call   8007c9 <cprintf>

    cprintf("spin may pass.\n");
  8018cc:	c7 04 24 85 1e 80 00 	movl   $0x801e85,(%esp)
  8018d3:	e8 f1 ee ff ff       	call   8007c9 <cprintf>
    return 0;
