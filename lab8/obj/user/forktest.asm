...
main(void) {
  ...
  8017b2:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8017b9:	00 
  8017ba:	eb 60                	jmp    80181c <main+0x73>
        if ((pid = fork()) == 0) {
  8017bc:	e8 c6 ec ff ff       	call   800487 <fork>
  8017c1:	89 44 24 18          	mov    %eax,0x18(%esp)
  8017c5:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8017ca:	75 20                	jne    8017ec <main+0x43>
            cprintf("I am child %d\n", n);
  8017cc:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8017d0:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017d4:	c7 04 24 64 1d 80 00 	movl   $0x801d64,(%esp)
  8017db:	e8 e9 ef ff ff       	call   8007c9 <cprintf>
            exit(0);
  8017e0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8017e7:	e8 7c ec ff ff       	call   800468 <exit>
        }
        assert(pid > 0);
  8017ec:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8017f1:	7f 24                	jg     801817 <main+0x6e>
  8017f3:	c7 44 24 0c 73 1d 80 	movl   $0x801d73,0xc(%esp)
  8017fa:	00 
  8017fb:	c7 44 24 08 7b 1d 80 	movl   $0x801d7b,0x8(%esp)
  801802:	00 
  801803:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  80180a:	00 
  80180b:	c7 04 24 90 1d 80 00 	movl   $0x801d90,(%esp)
  801812:	e8 09 e8 ff ff       	call   800020 <__panic>
    for (n = 0; n < max_child; n ++) {
  801817:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80181c:	b8 20 00 00 00       	mov    $0x20,%eax
  801821:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801825:	7c 95                	jl     8017bc <main+0x13>
    }

    if (n > max_child) {
  801827:	b8 20 00 00 00       	mov    $0x20,%eax
  80182c:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801830:	7e 24                	jle    801856 <main+0xad>
        panic("fork claimed to work %d times!\n", n);
  801832:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801836:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80183a:	c7 44 24 08 a0 1d 80 	movl   $0x801da0,0x8(%esp)
  801841:	00 
  801842:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801849:	00 
  80184a:	c7 04 24 90 1d 80 00 	movl   $0x801d90,(%esp)
  801851:	e8 ca e7 ff ff       	call   800020 <__panic>
    }

    for (; n > 0; n --) {
  801856:	eb 2a                	jmp    801882 <main+0xd9>
        if (wait() != 0) {
  801858:	e8 37 ec ff ff       	call   800494 <wait>
  80185d:	85 c0                	test   %eax,%eax
  80185f:	74 1c                	je     80187d <main+0xd4>
            panic("wait stopped early\n");
  801861:	c7 44 24 08 c0 1d 80 	movl   $0x801dc0,0x8(%esp)
  801868:	00 
  801869:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801870:	00 
  801871:	c7 04 24 90 1d 80 00 	movl   $0x801d90,(%esp)
  801878:	e8 a3 e7 ff ff       	call   800020 <__panic>
    for (; n > 0; n --) {
  80187d:	83 6c 24 1c 01       	subl   $0x1,0x1c(%esp)
  801882:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801887:	7f cf                	jg     801858 <main+0xaf>
        }
    }

    if (wait() == 0) {
  801889:	e8 06 ec ff ff       	call   800494 <wait>
  80188e:	85 c0                	test   %eax,%eax
  801890:	75 1c                	jne    8018ae <main+0x105>
        panic("wait got too many\n");
  801892:	c7 44 24 08 d4 1d 80 	movl   $0x801dd4,0x8(%esp)
  801899:	00 
  80189a:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8018a1:	00 
  8018a2:	c7 04 24 90 1d 80 00 	movl   $0x801d90,(%esp)
  8018a9:	e8 72 e7 ff ff       	call   800020 <__panic>
    }

    cprintf("forktest pass.\n");
  8018ae:	c7 04 24 e7 1d 80 00 	movl   $0x801de7,(%esp)
  8018b5:	e8 0f ef ff ff       	call   8007c9 <cprintf>
    return 0;
