...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 20 19 80 00 	movl   $0x801920,(%esp)
  ...
  800053:	e8 36 07 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 3a 19 80 00 	movl   $0x80193a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 3c 19 80 00 	movl   $0x80193c,(%esp)
  ...
  8000a3:	e8 e6 06 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 3a 19 80 00 	movl   $0x80193a,(%esp)
...
exit(int error_code) {
  ...
  800479:	c7 04 24 58 19 80 00 	movl   $0x801958,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800700:	c7 04 24 6b 19 80 00 	movl   $0x80196b,(%esp)
  ...
  80071e:	c7 04 24 76 19 80 00 	movl   $0x801976,(%esp)
  ...
  800734:	c7 04 24 88 19 80 00 	movl   $0x801988,(%esp)
  ...
  80074a:	c7 04 24 9b 19 80 00 	movl   $0x80199b,(%esp)
  ...
  800760:	c7 04 24 ae 19 80 00 	movl   $0x8019ae,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a1d:	00 
  800a1e:	c7 44 24 04 c1 19 80 	movl   $0x8019c1,0x4(%esp)
  800a25:	00 
  ...
  800a42:	c7 44 24 08 c8 19 80 	movl   $0x8019c8,0x8(%esp)
  800a49:	00 
  800a4a:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a51:	00 
  800a52:	c7 04 24 e2 19 80 00 	movl   $0x8019e2,(%esp)
  800a59:	e8 12 f6 ff ff       	call   800070 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a5e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a65:	00 
  800a66:	c7 44 24 04 f4 19 80 	movl   $0x8019f4,0x4(%esp)
  800a6d:	00 
  ...
  800a8a:	c7 44 24 08 fc 19 80 	movl   $0x8019fc,0x8(%esp)
  800a91:	00 
  800a92:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800a99:	00 
  800a9a:	c7 04 24 e2 19 80 00 	movl   $0x8019e2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  80109c:	05 24 1c 80 00       	add    $0x801c24,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  801200:	8b 04 85 48 1c 80 00 	mov    0x801c48(,%eax,4),%eax
  ...
  801319:	c7 44 24 0c 3e 1c 80 	movl   $0x801c3e,0xc(%esp)
  801320:	00 
  ...
  80134c:	75 05                	jne    801353 <vprintfmt+0x1c9>
                p = "(null)";
  80134e:	be 41 1c 80 00       	mov    $0x801c41,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017b2:	c7 04 24 a0 1d 80 00 	movl   $0x801da0,(%esp)
  8017b9:	e8 0b f0 ff ff       	call   8007c9 <cprintf>
    if ((pid = fork()) == 0) {
  8017be:	e8 c4 ec ff ff       	call   800487 <fork>
  8017c3:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8017c7:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8017cc:	75 3c                	jne    80180a <main+0x61>
        cprintf("I am the child.\n");
  8017ce:	c7 04 24 c7 1d 80 00 	movl   $0x801dc7,(%esp)
  8017d5:	e8 ef ef ff ff       	call   8007c9 <cprintf>
        yield();
  8017da:	e8 eb ec ff ff       	call   8004ca <yield>
        yield();
  8017df:	e8 e6 ec ff ff       	call   8004ca <yield>
        yield();
  8017e4:	e8 e1 ec ff ff       	call   8004ca <yield>
        yield();
  8017e9:	e8 dc ec ff ff       	call   8004ca <yield>
        yield();
  8017ee:	e8 d7 ec ff ff       	call   8004ca <yield>
        yield();
  8017f3:	e8 d2 ec ff ff       	call   8004ca <yield>
        yield();
  8017f8:	e8 cd ec ff ff       	call   8004ca <yield>
        exit(magic);
  8017fd:	a1 10 20 80 00       	mov    0x802010,%eax
  801802:	89 04 24             	mov    %eax,(%esp)
  801805:	e8 5e ec ff ff       	call   800468 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  80180a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80180e:	89 44 24 04          	mov    %eax,0x4(%esp)
  801812:	c7 04 24 d8 1d 80 00 	movl   $0x801dd8,(%esp)
  801819:	e8 ab ef ff ff       	call   8007c9 <cprintf>
    }
    assert(pid > 0);
  80181e:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801823:	7f 24                	jg     801849 <main+0xa0>
  801825:	c7 44 24 0c fa 1d 80 	movl   $0x801dfa,0xc(%esp)
  80182c:	00 
  80182d:	c7 44 24 08 02 1e 80 	movl   $0x801e02,0x8(%esp)
  801834:	00 
  801835:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  80183c:	00 
  80183d:	c7 04 24 17 1e 80 00 	movl   $0x801e17,(%esp)
  801844:	e8 d7 e7 ff ff       	call   800020 <__panic>
    cprintf("I am the parent, waiting now..\n");
  801849:	c7 04 24 24 1e 80 00 	movl   $0x801e24,(%esp)
  801850:	e8 74 ef ff ff       	call   8007c9 <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  801855:	8d 44 24 18          	lea    0x18(%esp),%eax
  801859:	89 44 24 04          	mov    %eax,0x4(%esp)
  80185d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801861:	89 04 24             	mov    %eax,(%esp)
  801864:	e8 47 ec ff ff       	call   8004b0 <waitpid>
  801869:	85 c0                	test   %eax,%eax
  80186b:	75 0d                	jne    80187a <main+0xd1>
  80186d:	8b 54 24 18          	mov    0x18(%esp),%edx
  801871:	a1 10 20 80 00       	mov    0x802010,%eax
  801876:	39 c2                	cmp    %eax,%edx
  801878:	74 24                	je     80189e <main+0xf5>
  80187a:	c7 44 24 0c 44 1e 80 	movl   $0x801e44,0xc(%esp)
  801881:	00 
  801882:	c7 44 24 08 02 1e 80 	movl   $0x801e02,0x8(%esp)
  801889:	00 
  80188a:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  801891:	00 
  801892:	c7 04 24 17 1e 80 00 	movl   $0x801e17,(%esp)
  801899:	e8 82 e7 ff ff       	call   800020 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  80189e:	8d 44 24 18          	lea    0x18(%esp),%eax
  8018a2:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018a6:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018aa:	89 04 24             	mov    %eax,(%esp)
  8018ad:	e8 fe eb ff ff       	call   8004b0 <waitpid>
  8018b2:	85 c0                	test   %eax,%eax
  8018b4:	74 09                	je     8018bf <main+0x116>
  8018b6:	e8 d9 eb ff ff       	call   800494 <wait>
  8018bb:	85 c0                	test   %eax,%eax
  8018bd:	75 24                	jne    8018e3 <main+0x13a>
  8018bf:	c7 44 24 0c 70 1e 80 	movl   $0x801e70,0xc(%esp)
  8018c6:	00 
  8018c7:	c7 44 24 08 02 1e 80 	movl   $0x801e02,0x8(%esp)
  8018ce:	00 
  8018cf:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8018d6:	00 
  8018d7:	c7 04 24 17 1e 80 00 	movl   $0x801e17,(%esp)
  8018de:	e8 3d e7 ff ff       	call   800020 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  8018e3:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018e7:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018eb:	c7 04 24 98 1e 80 00 	movl   $0x801e98,(%esp)
  8018f2:	e8 d2 ee ff ff       	call   8007c9 <cprintf>

    cprintf("exit pass.\n");
  8018f7:	c7 04 24 a8 1e 80 00 	movl   $0x801ea8,(%esp)
  8018fe:	e8 c6 ee ff ff       	call   8007c9 <cprintf>
    return 0;
