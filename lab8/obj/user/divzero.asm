...
main(void) {
  ...
  8017af:	83 ec 10             	sub    $0x10,%esp
    cprintf("value is %d.\n", 1 / zero);
  8017b2:	8b 0d 48 21 80 00    	mov    0x802148,%ecx
  8017b8:	b8 01 00 00 00       	mov    $0x1,%eax
  8017bd:	99                   	cltd   
  8017be:	f7 f9                	idiv   %ecx
  8017c0:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017c4:	c7 04 24 80 1c 80 00 	movl   $0x801c80,(%esp)
  8017cb:	e8 f9 ef ff ff       	call   8007c9 <cprintf>
    panic("FAIL: T.T\n");
  8017d0:	c7 44 24 08 8e 1c 80 	movl   $0x801c8e,0x8(%esp)
  8017d7:	00 
  8017d8:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  8017df:	00 
  8017e0:	c7 04 24 99 1c 80 00 	movl   $0x801c99,(%esp)
  8017e7:	e8 34 e8 ff ff       	call   800020 <__panic>
