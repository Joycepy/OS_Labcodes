...
umain(int argc, char *argv[]) {
  ...
  800ab3:	e8 f4 0d 00 00       	call   8018ac <main>
...
static int safe_open(const char *path, int open_flags)
{
  ...
  8017bc:	e8 d1 ed ff ff       	call   800592 <open>
  8017c1:	89 45 f4             	mov    %eax,-0xc(%ebp)
	printf("fd is %d\n",fd);
  8017c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017c7:	89 44 24 08          	mov    %eax,0x8(%esp)
  8017cb:	c7 44 24 04 80 1d 80 	movl   $0x801d80,0x4(%esp)
  8017d2:	00 
  8017d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8017da:	e8 ce f0 ff ff       	call   8008ad <fprintf>
	assert(fd >= 0);
  8017df:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  8017e3:	79 24                	jns    801809 <safe_open+0x60>
  8017e5:	c7 44 24 0c 8a 1d 80 	movl   $0x801d8a,0xc(%esp)
  8017ec:	00 
  8017ed:	c7 44 24 08 92 1d 80 	movl   $0x801d92,0x8(%esp)
  8017f4:	00 
  8017f5:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  8017fc:	00 
  8017fd:	c7 04 24 a7 1d 80 00 	movl   $0x801da7,(%esp)
  801804:	e8 17 e8 ff ff       	call   800020 <__panic>
	return fd;
...
static struct stat *safe_fstat(int fd)
{
  ...
  801814:	a1 10 20 80 00       	mov    0x802010,%eax
  801819:	89 44 24 04          	mov    %eax,0x4(%esp)
  80181d:	8b 45 08             	mov    0x8(%ebp),%eax
  801820:	89 04 24             	mov    %eax,(%esp)
  801823:	e8 fa ed ff ff       	call   800622 <fstat>
  801828:	89 45 f4             	mov    %eax,-0xc(%ebp)
	assert(ret == 0);
  80182b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  80182f:	74 24                	je     801855 <safe_fstat+0x47>
  801831:	c7 44 24 0c bc 1d 80 	movl   $0x801dbc,0xc(%esp)
  801838:	00 
  801839:	c7 44 24 08 92 1d 80 	movl   $0x801d92,0x8(%esp)
  801840:	00 
  801841:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  801848:	00 
  801849:	c7 04 24 a7 1d 80 00 	movl   $0x801da7,(%esp)
  801850:	e8 cb e7 ff ff       	call   800020 <__panic>
	return stat;
  801855:	a1 10 20 80 00       	mov    0x802010,%eax
}
  80185a:	c9                   	leave  
  80185b:	c3                   	ret    
...
static void safe_read(int fd, void *data, size_t len)
{
  ...
  801876:	e8 44 ed ff ff       	call   8005bf <read>
  80187b:	89 45 f4             	mov    %eax,-0xc(%ebp)
	assert(ret == len);
  80187e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801881:	3b 45 10             	cmp    0x10(%ebp),%eax
  801884:	74 24                	je     8018aa <safe_read+0x4e>
  801886:	c7 44 24 0c c5 1d 80 	movl   $0x801dc5,0xc(%esp)
  80188d:	00 
  80188e:	c7 44 24 08 92 1d 80 	movl   $0x801d92,0x8(%esp)
  801895:	00 
  801896:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  80189d:	00 
  80189e:	c7 04 24 a7 1d 80 00 	movl   $0x801da7,(%esp)
  8018a5:	e8 76 e7 ff ff       	call   800020 <__panic>
}
  8018aa:	c9                   	leave  
  8018ab:	c3                   	ret    
...
int main(void)
{
  ...
  8018b5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8018bc:	00 
  8018bd:	c7 04 24 d0 1d 80 00 	movl   $0x801dd0,(%esp)
  8018c4:	e8 e0 fe ff ff       	call   8017a9 <safe_open>
  8018c9:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	struct stat *stat = safe_fstat(fd1);
  8018cd:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018d1:	89 04 24             	mov    %eax,(%esp)
  8018d4:	e8 35 ff ff ff       	call   80180e <safe_fstat>
  8018d9:	89 44 24 18          	mov    %eax,0x18(%esp)
	assert(stat->st_size >= 0 && stat->st_blocks >= 0);
	printf("sfs_filetest1 pass.\n");
  8018dd:	c7 44 24 04 de 1d 80 	movl   $0x801dde,0x4(%esp)
  8018e4:	00 
  8018e5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8018ec:	e8 bc ef ff ff       	call   8008ad <fprintf>
	return 0;
