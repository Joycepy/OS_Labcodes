...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 a0 1b 80 00 	movl   $0x801ba0,(%esp)
  ...
  800053:	e8 36 07 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 ba 1b 80 00 	movl   $0x801bba,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 bc 1b 80 00 	movl   $0x801bbc,(%esp)
  ...
  8000a3:	e8 e6 06 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 ba 1b 80 00 	movl   $0x801bba,(%esp)
...
exit(int error_code) {
  ...
  800479:	c7 04 24 d8 1b 80 00 	movl   $0x801bd8,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800700:	c7 04 24 eb 1b 80 00 	movl   $0x801beb,(%esp)
  ...
  80071e:	c7 04 24 f6 1b 80 00 	movl   $0x801bf6,(%esp)
  ...
  800734:	c7 04 24 08 1c 80 00 	movl   $0x801c08,(%esp)
  ...
  80074a:	c7 04 24 1b 1c 80 00 	movl   $0x801c1b,(%esp)
  ...
  800760:	c7 04 24 2e 1c 80 00 	movl   $0x801c2e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a1d:	00 
  800a1e:	c7 44 24 04 41 1c 80 	movl   $0x801c41,0x4(%esp)
  800a25:	00 
  ...
  800a42:	c7 44 24 08 48 1c 80 	movl   $0x801c48,0x8(%esp)
  800a49:	00 
  800a4a:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a51:	00 
  800a52:	c7 04 24 62 1c 80 00 	movl   $0x801c62,(%esp)
  800a59:	e8 12 f6 ff ff       	call   800070 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a5e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a65:	00 
  800a66:	c7 44 24 04 74 1c 80 	movl   $0x801c74,0x4(%esp)
  800a6d:	00 
  ...
  800a8a:	c7 44 24 08 7c 1c 80 	movl   $0x801c7c,0x8(%esp)
  800a91:	00 
  800a92:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800a99:	00 
  800a9a:	c7 04 24 62 1c 80 00 	movl   $0x801c62,(%esp)
  ...
  800ab3:	e8 29 0f 00 00       	call   8019e1 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  80109c:	05 a4 1e 80 00       	add    $0x801ea4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  801200:	8b 04 85 c8 1e 80 00 	mov    0x801ec8(,%eax,4),%eax
  ...
  801319:	c7 44 24 0c be 1e 80 	movl   $0x801ebe,0xc(%esp)
  801320:	00 
  ...
  80134c:	75 05                	jne    801353 <vprintfmt+0x1c9>
                p = "(null)";
  80134e:	be c1 1e 80 00       	mov    $0x801ec1,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  8017b0:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  8017b7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8017be:	eb 65                	jmp    801825 <work+0x7c>
        for (j = 0; j < size; j ++) {
  8017c0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8017c7:	eb 50                	jmp    801819 <work+0x70>
            mata[i][j] = matb[i][j] = 1;
  ...
  8017da:	c7 04 85 e0 31 80 00 	movl   $0x1,0x8031e0(,%eax,4)
  8017e1:	01 00 00 00 
  ...
  8017f6:	8b 0c 85 e0 31 80 00 	mov    0x8031e0(,%eax,4),%ecx
  ...
  80180e:	89 0c 85 40 30 80 00 	mov    %ecx,0x803040(,%eax,4)
        for (j = 0; j < size; j ++) {
  801815:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801819:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80181c:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80181f:	7c a8                	jl     8017c9 <work+0x20>
    for (i = 0; i < size; i ++) {
  801821:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801825:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801828:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80182b:	7c 93                	jl     8017c0 <work+0x17>
        }
    }

    yield();
  80182d:	e8 98 ec ff ff       	call   8004ca <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  801832:	e8 b3 ec ff ff       	call   8004ea <getpid>
  801837:	8b 55 08             	mov    0x8(%ebp),%edx
  80183a:	89 54 24 08          	mov    %edx,0x8(%esp)
  80183e:	89 44 24 04          	mov    %eax,0x4(%esp)
  801842:	c7 04 24 20 20 80 00 	movl   $0x802020,(%esp)
  801849:	e8 7b ef ff ff       	call   8007c9 <cprintf>

    while (times -- > 0) {
  80184e:	e9 5c 01 00 00       	jmp    8019af <work+0x206>
        for (i = 0; i < size; i ++) {
  801853:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80185a:	e9 b6 00 00 00       	jmp    801915 <work+0x16c>
            for (j = 0; j < size; j ++) {
  80185f:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801866:	e9 9a 00 00 00       	jmp    801905 <work+0x15c>
                matc[i][j] = 0;
  ...
  801877:	8b 55 f0             	mov    -0x10(%ebp),%edx
  80187a:	01 d0                	add    %edx,%eax
  80187c:	c7 04 85 80 33 80 00 	movl   $0x0,0x803380(,%eax,4)
  801883:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  801887:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  80188e:	eb 69                	jmp    8018f9 <work+0x150>
  ...
  8018a1:	8b 0c 85 80 33 80 00 	mov    0x803380(,%eax,4),%ecx
  ...
  8018b9:	8b 1c 85 40 30 80 00 	mov    0x803040(,%eax,4),%ebx
  ...
  8018d1:	8b 04 85 e0 31 80 00 	mov    0x8031e0(,%eax,4),%eax
  8018d8:	0f af c3             	imul   %ebx,%eax
  8018db:	01 c1                	add    %eax,%ecx
  ...
  8018ee:	89 0c 85 80 33 80 00 	mov    %ecx,0x803380(,%eax,4)
                for (k = 0; k < size; k ++) {
  8018f5:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  8018f9:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8018fc:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8018ff:	7c 8f                	jl     801890 <work+0xe7>
            for (j = 0; j < size; j ++) {
  801901:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801905:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801908:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80190b:	0f 8c 5a ff ff ff    	jl     80186b <work+0xc2>
        for (i = 0; i < size; i ++) {
  801911:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801915:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801918:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80191b:	0f 8c 3e ff ff ff    	jl     80185f <work+0xb6>
                }
            }
        }
        for (i = 0; i < size; i ++) {
  801921:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801928:	eb 79                	jmp    8019a3 <work+0x1fa>
            for (j = 0; j < size; j ++) {
  80192a:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801931:	eb 64                	jmp    801997 <work+0x1ee>
  ...
  801944:	8b 0c 85 80 33 80 00 	mov    0x803380(,%eax,4),%ecx
  ...
  801957:	8b 55 f0             	mov    -0x10(%ebp),%edx
  80195a:	01 d0                	add    %edx,%eax
  80195c:	89 0c 85 e0 31 80 00 	mov    %ecx,0x8031e0(,%eax,4)
  ...
  801974:	8b 0c 85 e0 31 80 00 	mov    0x8031e0(,%eax,4),%ecx
  ...
  80198c:	89 0c 85 40 30 80 00 	mov    %ecx,0x803040(,%eax,4)
            for (j = 0; j < size; j ++) {
  801993:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801997:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80199a:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80199d:	7c 94                	jl     801933 <work+0x18a>
        for (i = 0; i < size; i ++) {
  80199f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8019a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8019a6:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8019a9:	0f 8c 7b ff ff ff    	jl     80192a <work+0x181>
    while (times -- > 0) {
  8019af:	8b 45 08             	mov    0x8(%ebp),%eax
  8019b2:	8d 50 ff             	lea    -0x1(%eax),%edx
  8019b5:	89 55 08             	mov    %edx,0x8(%ebp)
  8019b8:	85 c0                	test   %eax,%eax
  8019ba:	0f 85 93 fe ff ff    	jne    801853 <work+0xaa>
            }
        }
    }
    cprintf("pid %d done!.\n", getpid());
  8019c0:	e8 25 eb ff ff       	call   8004ea <getpid>
  8019c5:	89 44 24 04          	mov    %eax,0x4(%esp)
  8019c9:	c7 04 24 40 20 80 00 	movl   $0x802040,(%esp)
  8019d0:	e8 f4 ed ff ff       	call   8007c9 <cprintf>
    exit(0);
  8019d5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8019dc:	e8 87 ea ff ff       	call   800468 <exit>
...
int
main(void) {
  8019e1:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  8019e5:	83 e4 f0             	and    $0xfffffff0,%esp
  8019e8:	ff 71 fc             	pushl  -0x4(%ecx)
  8019eb:	55                   	push   %ebp
  ...
  8019f4:	89 e0                	mov    %esp,%eax
  8019f6:	89 c3                	mov    %eax,%ebx
    int pids[total];
  8019f8:	b8 15 00 00 00       	mov    $0x15,%eax
  8019fd:	83 e8 01             	sub    $0x1,%eax
  801a00:	89 45 e0             	mov    %eax,-0x20(%ebp)
  801a03:	b8 15 00 00 00       	mov    $0x15,%eax
  801a08:	c1 e0 02             	shl    $0x2,%eax
  801a0b:	8d 50 03             	lea    0x3(%eax),%edx
  801a0e:	b8 10 00 00 00       	mov    $0x10,%eax
  801a13:	83 e8 01             	sub    $0x1,%eax
  801a16:	01 d0                	add    %edx,%eax
  801a18:	be 10 00 00 00       	mov    $0x10,%esi
  801a1d:	ba 00 00 00 00       	mov    $0x0,%edx
  801a22:	f7 f6                	div    %esi
  801a24:	6b c0 10             	imul   $0x10,%eax,%eax
  801a27:	29 c4                	sub    %eax,%esp
  801a29:	8d 44 24 0c          	lea    0xc(%esp),%eax
  801a2d:	83 c0 03             	add    $0x3,%eax
  801a30:	c1 e8 02             	shr    $0x2,%eax
  801a33:	c1 e0 02             	shl    $0x2,%eax
  801a36:	89 45 dc             	mov    %eax,-0x24(%ebp)
    memset(pids, 0, sizeof(pids));
  801a39:	b8 15 00 00 00       	mov    $0x15,%eax
  801a3e:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801a45:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801a48:	89 54 24 08          	mov    %edx,0x8(%esp)
  801a4c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801a53:	00 
  801a54:	89 04 24             	mov    %eax,(%esp)
  801a57:	e8 c0 f3 ff ff       	call   800e1c <memset>

    int i;
    for (i = 0; i < total; i ++) {
  801a5c:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801a63:	eb 70                	jmp    801ad5 <main+0xf4>
        if ((pids[i] = fork()) == 0) {
  801a65:	e8 1d ea ff ff       	call   800487 <fork>
  801a6a:	8b 55 dc             	mov    -0x24(%ebp),%edx
  801a6d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  801a70:	89 04 8a             	mov    %eax,(%edx,%ecx,4)
  801a73:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801a76:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801a79:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801a7c:	85 c0                	test   %eax,%eax
  801a7e:	75 42                	jne    801ac2 <main+0xe1>
            srand(i * i);
  801a80:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801a83:	0f af 45 e4          	imul   -0x1c(%ebp),%eax
  801a87:	89 04 24             	mov    %eax,(%esp)
  801a8a:	e8 02 fd ff ff       	call   801791 <srand>
            int times = (((unsigned int)rand()) % total);
  801a8f:	e8 3d fc ff ff       	call   8016d1 <rand>
  801a94:	ba 15 00 00 00       	mov    $0x15,%edx
  801a99:	89 d1                	mov    %edx,%ecx
  801a9b:	ba 00 00 00 00       	mov    $0x0,%edx
  801aa0:	f7 f1                	div    %ecx
  801aa2:	89 d0                	mov    %edx,%eax
  801aa4:	89 45 d8             	mov    %eax,-0x28(%ebp)
            times = (times * times + 10) * 100;
  801aa7:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801aaa:	0f af 45 d8          	imul   -0x28(%ebp),%eax
  801aae:	83 c0 0a             	add    $0xa,%eax
  801ab1:	6b c0 64             	imul   $0x64,%eax,%eax
  801ab4:	89 45 d8             	mov    %eax,-0x28(%ebp)
            work(times);
  801ab7:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801aba:	89 04 24             	mov    %eax,(%esp)
  801abd:	e8 e7 fc ff ff       	call   8017a9 <work>
        }
        if (pids[i] < 0) {
  801ac2:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801ac5:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801ac8:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801acb:	85 c0                	test   %eax,%eax
  801acd:	79 02                	jns    801ad1 <main+0xf0>
            goto failed;
  801acf:	eb 5d                	jmp    801b2e <main+0x14d>
    for (i = 0; i < total; i ++) {
  801ad1:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801ad5:	b8 15 00 00 00       	mov    $0x15,%eax
  801ada:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801add:	7c 86                	jl     801a65 <main+0x84>
        }
    }

    cprintf("fork ok.\n");
  801adf:	c7 04 24 54 20 80 00 	movl   $0x802054,(%esp)
  801ae6:	e8 de ec ff ff       	call   8007c9 <cprintf>

    for (i = 0; i < total; i ++) {
  801aeb:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801af2:	eb 1b                	jmp    801b0f <main+0x12e>
        if (wait() != 0) {
  801af4:	e8 9b e9 ff ff       	call   800494 <wait>
  801af9:	85 c0                	test   %eax,%eax
  801afb:	74 0e                	je     801b0b <main+0x12a>
            cprintf("wait failed.\n");
  801afd:	c7 04 24 5e 20 80 00 	movl   $0x80205e,(%esp)
  801b04:	e8 c0 ec ff ff       	call   8007c9 <cprintf>
            goto failed;
  801b09:	eb 23                	jmp    801b2e <main+0x14d>
    for (i = 0; i < total; i ++) {
  801b0b:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801b0f:	b8 15 00 00 00       	mov    $0x15,%eax
  801b14:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801b17:	7c db                	jl     801af4 <main+0x113>
        }
    }

    cprintf("matrix pass.\n");
  801b19:	c7 04 24 6c 20 80 00 	movl   $0x80206c,(%esp)
  801b20:	e8 a4 ec ff ff       	call   8007c9 <cprintf>
    return 0;
  801b25:	b8 00 00 00 00       	mov    $0x0,%eax
  801b2a:	89 dc                	mov    %ebx,%esp
  801b2c:	eb 51                	jmp    801b7f <main+0x19e>

failed:
    for (i = 0; i < total; i ++) {
  801b2e:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801b35:	eb 22                	jmp    801b59 <main+0x178>
        if (pids[i] > 0) {
  801b37:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b3a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801b3d:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801b40:	85 c0                	test   %eax,%eax
  801b42:	7e 11                	jle    801b55 <main+0x174>
            kill(pids[i]);
  801b44:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b47:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801b4a:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801b4d:	89 04 24             	mov    %eax,(%esp)
  801b50:	e8 82 e9 ff ff       	call   8004d7 <kill>
    for (i = 0; i < total; i ++) {
  801b55:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801b59:	b8 15 00 00 00       	mov    $0x15,%eax
  801b5e:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801b61:	7c d4                	jl     801b37 <main+0x156>
        }
    }
    panic("FAIL: T.T\n");
  801b63:	c7 44 24 08 7a 20 80 	movl   $0x80207a,0x8(%esp)
  801b6a:	00 
  801b6b:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  801b72:	00 
  801b73:	c7 04 24 85 20 80 00 	movl   $0x802085,(%esp)
  801b7a:	e8 a1 e4 ff ff       	call   800020 <__panic>
}
  ...
  801b84:	5e                   	pop    %esi
  801b85:	5d                   	pop    %ebp
  801b86:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801b89:	c3                   	ret    
