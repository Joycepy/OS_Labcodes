...
main(void) {
  ...
  8017b2:	66 b8 28 00          	mov    $0x28,%ax
  8017b6:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  8017b8:	c7 44 24 08 60 1c 80 	movl   $0x801c60,0x8(%esp)
  8017bf:	00 
  8017c0:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  8017c7:	00 
  8017c8:	c7 04 24 6b 1c 80 00 	movl   $0x801c6b,(%esp)
  8017cf:	e8 4c e8 ff ff       	call   800020 <__panic>
