...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 60 1b 80 00 	movl   $0x801b60,(%esp)
  ...
  800053:	e8 36 07 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 7a 1b 80 00 	movl   $0x801b7a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 7c 1b 80 00 	movl   $0x801b7c,(%esp)
  ...
  8000a3:	e8 e6 06 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 7a 1b 80 00 	movl   $0x801b7a,(%esp)
...
lock_fork(void) {
  ...
  800443:	83 ec 18             	sub    $0x18,%esp
    lock(&fork_lock);
  800446:	c7 04 24 40 30 80 00 	movl   $0x803040,(%esp)
...
unlock_fork(void) {
  ...
  800457:	83 ec 04             	sub    $0x4,%esp
    unlock(&fork_lock);
  80045a:	c7 04 24 40 30 80 00 	movl   $0x803040,(%esp)
...
exit(int error_code) {
  ...
  800479:	c7 04 24 98 1b 80 00 	movl   $0x801b98,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800700:	c7 04 24 ab 1b 80 00 	movl   $0x801bab,(%esp)
  ...
  80071e:	c7 04 24 b6 1b 80 00 	movl   $0x801bb6,(%esp)
  ...
  800734:	c7 04 24 c8 1b 80 00 	movl   $0x801bc8,(%esp)
  ...
  80074a:	c7 04 24 db 1b 80 00 	movl   $0x801bdb,(%esp)
  ...
  800760:	c7 04 24 ee 1b 80 00 	movl   $0x801bee,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a1d:	00 
  800a1e:	c7 44 24 04 01 1c 80 	movl   $0x801c01,0x4(%esp)
  800a25:	00 
  ...
  800a42:	c7 44 24 08 08 1c 80 	movl   $0x801c08,0x8(%esp)
  800a49:	00 
  800a4a:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a51:	00 
  800a52:	c7 04 24 22 1c 80 00 	movl   $0x801c22,(%esp)
  800a59:	e8 12 f6 ff ff       	call   800070 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a5e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a65:	00 
  800a66:	c7 44 24 04 34 1c 80 	movl   $0x801c34,0x4(%esp)
  800a6d:	00 
  ...
  800a8a:	c7 44 24 08 3c 1c 80 	movl   $0x801c3c,0x8(%esp)
  800a91:	00 
  800a92:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800a99:	00 
  800a9a:	c7 04 24 22 1c 80 00 	movl   $0x801c22,(%esp)
  ...
  800ab3:	e8 37 10 00 00       	call   801aef <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  80109c:	05 64 1e 80 00       	add    $0x801e64,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  801200:	8b 04 85 88 1e 80 00 	mov    0x801e88(,%eax,4),%eax
  ...
  801319:	c7 44 24 0c 7e 1e 80 	movl   $0x801e7e,0xc(%esp)
  801320:	00 
  ...
  80134c:	75 05                	jne    801353 <vprintfmt+0x1c9>
                p = "(null)";
  80134e:	be 81 1e 80 00       	mov    $0x801e81,%esi
            }
            if (width > 0 && padc != '-') {
...
getmode(uint32_t st_mode) {
  ...
  8017ac:	83 ec 10             	sub    $0x10,%esp
    char mode = '?';
  8017af:	c6 45 ff 3f          	movb   $0x3f,-0x1(%ebp)
    if (S_ISREG(st_mode)) mode = '-';
  8017b3:	8b 45 08             	mov    0x8(%ebp),%eax
  8017b6:	25 00 70 00 00       	and    $0x7000,%eax
  8017bb:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8017c0:	75 04                	jne    8017c6 <getmode+0x1d>
  8017c2:	c6 45 ff 2d          	movb   $0x2d,-0x1(%ebp)
    if (S_ISDIR(st_mode)) mode = 'd';
  8017c6:	8b 45 08             	mov    0x8(%ebp),%eax
  8017c9:	25 00 70 00 00       	and    $0x7000,%eax
  8017ce:	3d 00 20 00 00       	cmp    $0x2000,%eax
  8017d3:	75 04                	jne    8017d9 <getmode+0x30>
  8017d5:	c6 45 ff 64          	movb   $0x64,-0x1(%ebp)
    if (S_ISLNK(st_mode)) mode = 'l';
  8017d9:	8b 45 08             	mov    0x8(%ebp),%eax
  8017dc:	25 00 70 00 00       	and    $0x7000,%eax
  8017e1:	3d 00 30 00 00       	cmp    $0x3000,%eax
  8017e6:	75 04                	jne    8017ec <getmode+0x43>
  8017e8:	c6 45 ff 6c          	movb   $0x6c,-0x1(%ebp)
    if (S_ISCHR(st_mode)) mode = 'c';
  8017ec:	8b 45 08             	mov    0x8(%ebp),%eax
  8017ef:	25 00 70 00 00       	and    $0x7000,%eax
  8017f4:	3d 00 40 00 00       	cmp    $0x4000,%eax
  8017f9:	75 04                	jne    8017ff <getmode+0x56>
  8017fb:	c6 45 ff 63          	movb   $0x63,-0x1(%ebp)
    if (S_ISBLK(st_mode)) mode = 'b';
  8017ff:	8b 45 08             	mov    0x8(%ebp),%eax
  801802:	25 00 70 00 00       	and    $0x7000,%eax
  801807:	3d 00 50 00 00       	cmp    $0x5000,%eax
  80180c:	75 04                	jne    801812 <getmode+0x69>
  80180e:	c6 45 ff 62          	movb   $0x62,-0x1(%ebp)
    return mode;
  801812:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
  801816:	c9                   	leave  
  801817:	c3                   	ret    
...
getstat(const char *name, struct stat *stat) {
  ...
  80182c:	e8 61 ed ff ff       	call   800592 <open>
  801831:	89 45 f4             	mov    %eax,-0xc(%ebp)
  801834:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801838:	79 05                	jns    80183f <getstat+0x27>
        return fd;
  80183a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80183d:	eb 23                	jmp    801862 <getstat+0x4a>
    }
    ret = fstat(fd, stat);
...
lsstat(struct stat *stat, const char *filename) {
  ...
  801872:	e8 32 ff ff ff       	call   8017a9 <getmode>
  801877:	0f be c0             	movsbl %al,%eax
  80187a:	89 44 24 08          	mov    %eax,0x8(%esp)
  80187e:	c7 44 24 04 e0 1f 80 	movl   $0x801fe0,0x4(%esp)
  801885:	00 
  801886:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  80188d:	e8 1b f0 ff ff       	call   8008ad <fprintf>
    printf(" %3d(h)", stat->st_nlinks);
  801892:	8b 45 08             	mov    0x8(%ebp),%eax
  801895:	8b 40 04             	mov    0x4(%eax),%eax
  801898:	89 44 24 08          	mov    %eax,0x8(%esp)
  80189c:	c7 44 24 04 e8 1f 80 	movl   $0x801fe8,0x4(%esp)
  8018a3:	00 
  8018a4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8018ab:	e8 fd ef ff ff       	call   8008ad <fprintf>
  ...
  8018ba:	c7 44 24 04 f0 1f 80 	movl   $0x801ff0,0x4(%esp)
  8018c1:	00 
  8018c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8018c9:	e8 df ef ff ff       	call   8008ad <fprintf>
    printf(" %8d(s)", stat->st_size);
  8018ce:	8b 45 08             	mov    0x8(%ebp),%eax
  8018d1:	8b 40 0c             	mov    0xc(%eax),%eax
  8018d4:	89 44 24 08          	mov    %eax,0x8(%esp)
  8018d8:	c7 44 24 04 f8 1f 80 	movl   $0x801ff8,0x4(%esp)
  8018df:	00 
  8018e0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8018e7:	e8 c1 ef ff ff       	call   8008ad <fprintf>
    printf("   %s\n", filename);
  8018ec:	8b 45 0c             	mov    0xc(%ebp),%eax
  8018ef:	89 44 24 08          	mov    %eax,0x8(%esp)
  8018f3:	c7 44 24 04 00 20 80 	movl   $0x802000,0x4(%esp)
  8018fa:	00 
  8018fb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801902:	e8 a6 ef ff ff       	call   8008ad <fprintf>
}
  801907:	c9                   	leave  
  801908:	c3                   	ret    
...
lsdir(const char *path) {
  ...
  80190c:	83 ec 38             	sub    $0x38,%esp
    struct stat __stat, *stat = &__stat;
  80190f:	8d 45 d8             	lea    -0x28(%ebp),%eax
  801912:	89 45 f4             	mov    %eax,-0xc(%ebp)
    int ret;
    DIR *dirp = opendir(".");
  801915:	c7 04 24 07 20 80 00 	movl   $0x802007,(%esp)
  80191c:	e8 b9 ef ff ff       	call   8008da <opendir>
  801921:	89 45 f0             	mov    %eax,-0x10(%ebp)
    
    if (dirp == NULL) {
  801924:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801928:	75 07                	jne    801931 <lsdir+0x28>
        return -1;
  80192a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  80192f:	eb 7e                	jmp    8019af <lsdir+0xa6>
    }
    struct dirent *direntp;
    while ((direntp = readdir(dirp)) != NULL) {
  801931:	eb 44                	jmp    801977 <lsdir+0x6e>
  ...
  801940:	89 14 24             	mov    %edx,(%esp)
  801943:	e8 d0 fe ff ff       	call   801818 <getstat>
  801948:	89 45 e8             	mov    %eax,-0x18(%ebp)
  80194b:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  80194f:	74 11                	je     801962 <lsdir+0x59>
            goto failed;
  801951:	90                   	nop
    }
    printf("lsdir: step 4\n");
...
failed:
  ...
  801958:	e8 26 f0 ff ff       	call   800983 <closedir>
    return ret;
  80195d:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801960:	eb 4d                	jmp    8019af <lsdir+0xa6>
        lsstat(stat, direntp->name);
  801962:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801965:	83 c0 04             	add    $0x4,%eax
  801968:	89 44 24 04          	mov    %eax,0x4(%esp)
  80196c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80196f:	89 04 24             	mov    %eax,(%esp)
  801972:	e8 ed fe ff ff       	call   801864 <lsstat>
    while ((direntp = readdir(dirp)) != NULL) {
  801977:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80197a:	89 04 24             	mov    %eax,(%esp)
  80197d:	e8 d1 ef ff ff       	call   800953 <readdir>
  801982:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801985:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801989:	75 a8                	jne    801933 <lsdir+0x2a>
    printf("lsdir: step 4\n");
  80198b:	c7 44 24 04 09 20 80 	movl   $0x802009,0x4(%esp)
  801992:	00 
  801993:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  80199a:	e8 0e ef ff ff       	call   8008ad <fprintf>
    closedir(dirp);
  80199f:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8019a2:	89 04 24             	mov    %eax,(%esp)
  8019a5:	e8 d9 ef ff ff       	call   800983 <closedir>
    return 0;
...
ls(const char *path) {
  ...
  8019b4:	83 ec 38             	sub    $0x38,%esp
    struct stat __stat, *stat = &__stat;
  8019b7:	8d 45 dc             	lea    -0x24(%ebp),%eax
  ...
  8019ca:	e8 49 fe ff ff       	call   801818 <getstat>
  8019cf:	89 45 ec             	mov    %eax,-0x14(%ebp)
  8019d2:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8019d6:	74 08                	je     8019e0 <ls+0x2f>
        return ret;
  8019d8:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8019db:	e9 0d 01 00 00       	jmp    801aed <ls+0x13c>
        " [ symlink ]",
        " [character]",
        " [  block  ]",
        " [  ?????  ]",
  ...
  8019e8:	e8 bc fd ff ff       	call   8017a9 <getmode>
  8019ed:	0f be c0             	movsbl %al,%eax
  8019f0:	83 f8 63             	cmp    $0x63,%eax
  8019f3:	74 38                	je     801a2d <ls+0x7c>
  8019f5:	83 f8 63             	cmp    $0x63,%eax
  8019f8:	7f 0c                	jg     801a06 <ls+0x55>
  8019fa:	83 f8 30             	cmp    $0x30,%eax
  8019fd:	74 13                	je     801a12 <ls+0x61>
  8019ff:	83 f8 62             	cmp    $0x62,%eax
  801a02:	74 32                	je     801a36 <ls+0x85>
  801a04:	eb 39                	jmp    801a3f <ls+0x8e>
  801a06:	83 f8 64             	cmp    $0x64,%eax
  801a09:	74 10                	je     801a1b <ls+0x6a>
  801a0b:	83 f8 6c             	cmp    $0x6c,%eax
  801a0e:	74 14                	je     801a24 <ls+0x73>
  801a10:	eb 2d                	jmp    801a3f <ls+0x8e>
    case '0': type = 0; break;
  801a12:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801a19:	eb 2c                	jmp    801a47 <ls+0x96>
    case 'd': type = 1; break;
  801a1b:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
  801a22:	eb 23                	jmp    801a47 <ls+0x96>
    case 'l': type = 2; break;
  801a24:	c7 45 f4 02 00 00 00 	movl   $0x2,-0xc(%ebp)
  801a2b:	eb 1a                	jmp    801a47 <ls+0x96>
    case 'c': type = 3; break;
  801a2d:	c7 45 f4 03 00 00 00 	movl   $0x3,-0xc(%ebp)
  801a34:	eb 11                	jmp    801a47 <ls+0x96>
    case 'b': type = 4; break;
  801a36:	c7 45 f4 04 00 00 00 	movl   $0x4,-0xc(%ebp)
  801a3d:	eb 08                	jmp    801a47 <ls+0x96>
    default:  type = 5; break;
  801a3f:	c7 45 f4 05 00 00 00 	movl   $0x5,-0xc(%ebp)
  801a46:	90                   	nop
    }

    printf(" @ is %s", filetype[type]);
  801a47:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a4a:	8b 04 85 10 30 80 00 	mov    0x803010(,%eax,4),%eax
  801a51:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a55:	c7 44 24 04 18 20 80 	movl   $0x802018,0x4(%esp)
  801a5c:	00 
  801a5d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a64:	e8 44 ee ff ff       	call   8008ad <fprintf>
    printf(" %d(hlinks)", stat->st_nlinks);
  801a69:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801a6c:	8b 40 04             	mov    0x4(%eax),%eax
  801a6f:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a73:	c7 44 24 04 21 20 80 	movl   $0x802021,0x4(%esp)
  801a7a:	00 
  801a7b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a82:	e8 26 ee ff ff       	call   8008ad <fprintf>
    printf(" %d(blocks)", stat->st_blocks);
  801a87:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801a8a:	8b 40 08             	mov    0x8(%eax),%eax
  801a8d:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a91:	c7 44 24 04 2d 20 80 	movl   $0x80202d,0x4(%esp)
  801a98:	00 
  801a99:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801aa0:	e8 08 ee ff ff       	call   8008ad <fprintf>
    printf(" %d(bytes) : @'%s'\n", stat->st_size, path);
  801aa5:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801aa8:	8b 40 0c             	mov    0xc(%eax),%eax
  801aab:	8b 55 08             	mov    0x8(%ebp),%edx
  801aae:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801ab2:	89 44 24 08          	mov    %eax,0x8(%esp)
  801ab6:	c7 44 24 04 39 20 80 	movl   $0x802039,0x4(%esp)
  801abd:	00 
  801abe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801ac5:	e8 e3 ed ff ff       	call   8008ad <fprintf>
    if (S_ISDIR(stat->st_mode)) {
  801aca:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801acd:	8b 00                	mov    (%eax),%eax
  801acf:	25 00 70 00 00       	and    $0x7000,%eax
  801ad4:	3d 00 20 00 00       	cmp    $0x2000,%eax
  801ad9:	75 0d                	jne    801ae8 <ls+0x137>
        return lsdir(path);
  801adb:	8b 45 08             	mov    0x8(%ebp),%eax
  801ade:	89 04 24             	mov    %eax,(%esp)
  801ae1:	e8 23 fe ff ff       	call   801909 <lsdir>
  801ae6:	eb 05                	jmp    801aed <ls+0x13c>
    }
    return 0;
...
main(int argc, char **argv) {
  ...
  801af2:	83 e4 f0             	and    $0xfffffff0,%esp
  801af5:	83 ec 20             	sub    $0x20,%esp
    if (argc == 1) {
  801af8:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
  801afc:	75 0e                	jne    801b0c <main+0x1d>
        return ls(".");
  801afe:	c7 04 24 07 20 80 00 	movl   $0x802007,(%esp)
  801b05:	e8 a7 fe ff ff       	call   8019b1 <ls>
  801b0a:	eb 48                	jmp    801b54 <main+0x65>
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801b0c:	c7 44 24 1c 01 00 00 	movl   $0x1,0x1c(%esp)
  801b13:	00 
  801b14:	eb 30                	jmp    801b46 <main+0x57>
            if ((ret = ls(argv[i])) != 0) {
  801b16:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  ...
  801b2b:	e8 81 fe ff ff       	call   8019b1 <ls>
  801b30:	89 44 24 18          	mov    %eax,0x18(%esp)
  801b34:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801b39:	74 06                	je     801b41 <main+0x52>
                return ret;
  801b3b:	8b 44 24 18          	mov    0x18(%esp),%eax
  801b3f:	eb 13                	jmp    801b54 <main+0x65>
        for (i = 1; i < argc; i ++) {
  801b41:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801b46:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b4a:	3b 45 08             	cmp    0x8(%ebp),%eax
  801b4d:	7c c7                	jl     801b16 <main+0x27>
            }
        }
    }
    return 0;
