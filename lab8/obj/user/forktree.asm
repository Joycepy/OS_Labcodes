...
umain(int argc, char *argv[]) {
  ...
  800ab3:	e8 a8 0d 00 00       	call   801860 <main>
...
forkchild(const char *cur, char branch) {
  ...
  8017ac:	83 ec 38             	sub    $0x38,%esp
  8017af:	8b 45 0c             	mov    0xc(%ebp),%eax
  8017b2:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  8017b5:	8b 45 08             	mov    0x8(%ebp),%eax
  8017b8:	89 04 24             	mov    %eax,(%esp)
  8017bb:	e8 06 f3 ff ff       	call   800ac6 <strlen>
  8017c0:	83 f8 03             	cmp    $0x3,%eax
  8017c3:	77 4f                	ja     801814 <forkchild+0x6b>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  8017c5:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  8017c9:	89 44 24 10          	mov    %eax,0x10(%esp)
  8017cd:	8b 45 08             	mov    0x8(%ebp),%eax
  8017d0:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8017d4:	c7 44 24 08 20 1d 80 	movl   $0x801d20,0x8(%esp)
  8017db:	00 
  8017dc:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
  8017e3:	00 
  8017e4:	8d 45 f3             	lea    -0xd(%ebp),%eax
  8017e7:	89 04 24             	mov    %eax,(%esp)
  8017ea:	e8 1d fe ff ff       	call   80160c <snprintf>
    if (fork() == 0) {
  8017ef:	e8 93 ec ff ff       	call   800487 <fork>
  8017f4:	85 c0                	test   %eax,%eax
  8017f6:	75 1c                	jne    801814 <forkchild+0x6b>
        forktree(nxt);
  8017f8:	8d 45 f3             	lea    -0xd(%ebp),%eax
  8017fb:	89 04 24             	mov    %eax,(%esp)
  8017fe:	e8 13 00 00 00       	call   801816 <forktree>
        yield();
  801803:	e8 c2 ec ff ff       	call   8004ca <yield>
        exit(0);
  801808:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80180f:	e8 54 ec ff ff       	call   800468 <exit>
    }
}
  801814:	c9                   	leave  
  801815:	c3                   	ret    
...
forktree(const char *cur) {
  ...
  801819:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  80181c:	e8 c9 ec ff ff       	call   8004ea <getpid>
  801821:	8b 55 08             	mov    0x8(%ebp),%edx
  801824:	89 54 24 08          	mov    %edx,0x8(%esp)
  801828:	89 44 24 04          	mov    %eax,0x4(%esp)
  80182c:	c7 04 24 25 1d 80 00 	movl   $0x801d25,(%esp)
  801833:	e8 91 ef ff ff       	call   8007c9 <cprintf>

    forkchild(cur, '0');
  801838:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  80183f:	00 
  801840:	8b 45 08             	mov    0x8(%ebp),%eax
  801843:	89 04 24             	mov    %eax,(%esp)
  801846:	e8 5e ff ff ff       	call   8017a9 <forkchild>
    forkchild(cur, '1');
  80184b:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  801852:	00 
  801853:	8b 45 08             	mov    0x8(%ebp),%eax
  801856:	89 04 24             	mov    %eax,(%esp)
  801859:	e8 4b ff ff ff       	call   8017a9 <forkchild>
}
  80185e:	c9                   	leave  
  80185f:	c3                   	ret    
...
main(void) {
  ...
  801863:	83 e4 f0             	and    $0xfffffff0,%esp
  801866:	83 ec 10             	sub    $0x10,%esp
    cprintf("forktree process will sleep %d ticks\n",SLEEP_TIME);
  801869:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  801870:	00 
  801871:	c7 04 24 38 1d 80 00 	movl   $0x801d38,(%esp)
  801878:	e8 4c ef ff ff       	call   8007c9 <cprintf>
    sleep(SLEEP_TIME);
  80187d:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  801884:	e8 8e ec ff ff       	call   800517 <sleep>
    forktree("");
  801889:	c7 04 24 5e 1d 80 00 	movl   $0x801d5e,(%esp)
  801890:	e8 81 ff ff ff       	call   801816 <forktree>
    return 0;
