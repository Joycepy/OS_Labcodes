...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 40 18 80 00 	movl   $0x801840,(%esp)
  ...
  800053:	e8 36 07 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 5a 18 80 00 	movl   $0x80185a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 5c 18 80 00 	movl   $0x80185c,(%esp)
  ...
  8000a3:	e8 e6 06 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 5a 18 80 00 	movl   $0x80185a,(%esp)
...
exit(int error_code) {
  ...
  800479:	c7 04 24 78 18 80 00 	movl   $0x801878,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800700:	c7 04 24 8b 18 80 00 	movl   $0x80188b,(%esp)
  ...
  80071e:	c7 04 24 96 18 80 00 	movl   $0x801896,(%esp)
  ...
  800734:	c7 04 24 a8 18 80 00 	movl   $0x8018a8,(%esp)
  ...
  80074a:	c7 04 24 bb 18 80 00 	movl   $0x8018bb,(%esp)
  ...
  800760:	c7 04 24 ce 18 80 00 	movl   $0x8018ce,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a1d:	00 
  800a1e:	c7 44 24 04 e1 18 80 	movl   $0x8018e1,0x4(%esp)
  800a25:	00 
  ...
  800a42:	c7 44 24 08 e8 18 80 	movl   $0x8018e8,0x8(%esp)
  800a49:	00 
  800a4a:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a51:	00 
  800a52:	c7 04 24 02 19 80 00 	movl   $0x801902,(%esp)
  800a59:	e8 12 f6 ff ff       	call   800070 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a5e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a65:	00 
  800a66:	c7 44 24 04 14 19 80 	movl   $0x801914,0x4(%esp)
  800a6d:	00 
  ...
  800a8a:	c7 44 24 08 1c 19 80 	movl   $0x80191c,0x8(%esp)
  800a91:	00 
  800a92:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800a99:	00 
  800a9a:	c7 04 24 02 19 80 00 	movl   $0x801902,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  80109c:	05 44 1b 80 00       	add    $0x801b44,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  801200:	8b 04 85 68 1b 80 00 	mov    0x801b68(,%eax,4),%eax
  ...
  801319:	c7 44 24 0c 5e 1b 80 	movl   $0x801b5e,0xc(%esp)
  801320:	00 
  ...
  80134c:	75 05                	jne    801353 <vprintfmt+0x1c9>
                p = "(null)";
  80134e:	be 61 1b 80 00       	mov    $0x801b61,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017b2:	e8 33 ed ff ff       	call   8004ea <getpid>
  8017b7:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017bb:	c7 04 24 c0 1c 80 00 	movl   $0x801cc0,(%esp)
  8017c2:	e8 02 f0 ff ff       	call   8007c9 <cprintf>
    for (i = 0; i < 5; i ++) {
  8017c7:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8017ce:	00 
  8017cf:	eb 27                	jmp    8017f8 <main+0x4f>
        yield();
  8017d1:	e8 f4 ec ff ff       	call   8004ca <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  8017d6:	e8 0f ed ff ff       	call   8004ea <getpid>
  8017db:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8017df:	89 54 24 08          	mov    %edx,0x8(%esp)
  8017e3:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017e7:	c7 04 24 dc 1c 80 00 	movl   $0x801cdc,(%esp)
  8017ee:	e8 d6 ef ff ff       	call   8007c9 <cprintf>
    for (i = 0; i < 5; i ++) {
  8017f3:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8017f8:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  8017fd:	7e d2                	jle    8017d1 <main+0x28>
    }
    cprintf("All done in process %d.\n", getpid());
  8017ff:	e8 e6 ec ff ff       	call   8004ea <getpid>
  801804:	89 44 24 04          	mov    %eax,0x4(%esp)
  801808:	c7 04 24 ff 1c 80 00 	movl   $0x801cff,(%esp)
  80180f:	e8 b5 ef ff ff       	call   8007c9 <cprintf>
    cprintf("yield pass.\n");
  801814:	c7 04 24 18 1d 80 00 	movl   $0x801d18,(%esp)
  80181b:	e8 a9 ef ff ff       	call   8007c9 <cprintf>
    return 0;
