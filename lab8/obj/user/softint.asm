...
main(void) {
  ...
  8017af:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  8017b2:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  8017b4:	c7 44 24 08 60 1c 80 	movl   $0x801c60,0x8(%esp)
  8017bb:	00 
  8017bc:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  8017c3:	00 
  8017c4:	c7 04 24 6b 1c 80 00 	movl   $0x801c6b,(%esp)
  8017cb:	e8 50 e8 ff ff       	call   800020 <__panic>
