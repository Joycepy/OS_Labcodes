...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 e0 17 80 00 	movl   $0x8017e0,(%esp)
  ...
  800053:	e8 36 07 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 fa 17 80 00 	movl   $0x8017fa,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 fc 17 80 00 	movl   $0x8017fc,(%esp)
  ...
  8000a3:	e8 e6 06 00 00       	call   80078e <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 fa 17 80 00 	movl   $0x8017fa,(%esp)
...
exit(int error_code) {
  ...
  800479:	c7 04 24 18 18 80 00 	movl   $0x801818,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800700:	c7 04 24 2b 18 80 00 	movl   $0x80182b,(%esp)
  ...
  80071e:	c7 04 24 36 18 80 00 	movl   $0x801836,(%esp)
  ...
  800734:	c7 04 24 48 18 80 00 	movl   $0x801848,(%esp)
  ...
  80074a:	c7 04 24 5b 18 80 00 	movl   $0x80185b,(%esp)
  ...
  800760:	c7 04 24 6e 18 80 00 	movl   $0x80186e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a1d:	00 
  800a1e:	c7 44 24 04 81 18 80 	movl   $0x801881,0x4(%esp)
  800a25:	00 
  ...
  800a42:	c7 44 24 08 88 18 80 	movl   $0x801888,0x8(%esp)
  800a49:	00 
  800a4a:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a51:	00 
  800a52:	c7 04 24 a2 18 80 00 	movl   $0x8018a2,(%esp)
  800a59:	e8 12 f6 ff ff       	call   800070 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a5e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a65:	00 
  800a66:	c7 44 24 04 b4 18 80 	movl   $0x8018b4,0x4(%esp)
  800a6d:	00 
  ...
  800a8a:	c7 44 24 08 bc 18 80 	movl   $0x8018bc,0x8(%esp)
  800a91:	00 
  800a92:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800a99:	00 
  800a9a:	c7 04 24 a2 18 80 00 	movl   $0x8018a2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  80109c:	05 e4 1a 80 00       	add    $0x801ae4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  801200:	8b 04 85 08 1b 80 00 	mov    0x801b08(,%eax,4),%eax
  ...
  801319:	c7 44 24 0c fe 1a 80 	movl   $0x801afe,0xc(%esp)
  801320:	00 
  ...
  80134c:	75 05                	jne    801353 <vprintfmt+0x1c9>
                p = "(null)";
  80134e:	be 01 1b 80 00       	mov    $0x801b01,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017bb:	c7 04 24 60 1c 80 00 	movl   $0x801c60,(%esp)
  8017c2:	e8 02 f0 ff ff       	call   8007c9 <cprintf>
    print_pgdir();
  8017c7:	e8 2b ed ff ff       	call   8004f7 <print_pgdir>
    cprintf("pgdir pass.\n");
  8017cc:	c7 04 24 77 1c 80 00 	movl   $0x801c77,(%esp)
  8017d3:	e8 f1 ef ff ff       	call   8007c9 <cprintf>
    return 0;
